		...
		<script type="text/javascript">
				...
				function publishData(){
					...
					layer.confirm('您确定要发布吗?', {
						...
						$.ajax({
							type: "POST",
							url: "${pageContext.request.contextPath }/dataDownload/publishData.html?id=" + ids,
							success: function(data) {
								layer.msg('发布成功', {
									offset: ['40%', '45%']
								});
				...
				//查看资料
				function view(obj){
					window.location.href = "${pageContext.request.contextPath}/dataDownload/view.html?id="+obj;
				}
						...
						$.ajax({
							...
							success: function(data) {
								if(data==0){
									...
									window.location.href = "${pageContext.request.contextPath }/dataDownload/edit.html?id="+str;
								}
							}
						});
					}
  ...
  <body>
    <!--面包屑导航开始-->
		<div class="margin-top-10 breadcrumbs ">
			<div class="container">
				<ul class="breadcrumb margin-left-0">
					...
					<li><a>信息服务</a></li>
					<li>
						<a href="javascript:jumppage('${pageContext.request.contextPath}/dataDownload/getList.html')">资料下载管理</a>
					</li>
				</ul>
				<div class="clear"></div>
			</div>
		...
		<div class="container">
			...
			<form action="${pageContext.request.contextPath }/dataDownload/getList.html" method="post" id="form">
      ...
      <div class="row">
        <div class="col-xs-2 col-sm-4 col-md-4 col-lg-3">
          <div class="row">
            <div class="col-xs-4 f14 h32 lh32 tr text-nowrapEl">资料名称：</div>
            <div class="col-xs-8 f0 lh0">
              <input type="text" id="name" name="name" value="${dataDownload.name }" class="w100p h32 f14 mb0">
            </div>
          </div>
        </div>
