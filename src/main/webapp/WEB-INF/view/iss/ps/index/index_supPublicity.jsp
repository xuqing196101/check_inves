     ...
     <form id="queryForm" method="get">
        ...
        <div class="report_list_box">
            <div class="report_list_title">
          	  <div class="col-md-3 col-xs-3 col-sm-3 f16">供应商名称</div>
              ...
              <div class="col-md-3 col-xs-3 col-sm-3 f16">审核结果</div>
              <div class="col-md-2 col-xs-2 col-sm-2 f16 text-right">公示时间</div>
              <div class="clear"></div>
            </div>
