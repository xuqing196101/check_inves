	    ...
	    jump: function(e, first){ //触发分页后的回调
	        if(!first){ //一定要加此判断，否则初始时会无限刷新
	            ...
	            var publishStartDate=$("#publishStartDate").val();
	       	    ...
	       	    var url="${pageContext.request.contextPath}/index/selectIndexNewsByParId.html?id="+id+"&page="+e.curr+"&title="+title+"&productType="+productType+"&productTypeName="+productTypeName+"&tab="+tab+"&lastArticleTypeName="+lastArticleTypeName+"&publishStartDate="+publishStartDate+"&publishEndDate="+publishEndDate;
...
function query(){
	...
	//alert(title);
	 ...
	 var url="${pageContext.request.contextPath}/index/selectIndexNewsByParId.html?id="+id+"&title="+title+"&productType="+productType+"&productTypeName="+productTypeName+"&tab="+tab+"&lastArticleTypeName="+lastArticleTypeName+"&publishStartDate="+publishStartDate+"&publishEndDate="+publishEndDate;
	 window.location.href = encodeURI(encodeURI(url));
}
function myReSet(){
	var url="${pageContext.request.contextPath}/index/selectIndexNewsByParId.html?id="+id+"&tab="+tab;
	window.location.href = encodeURI(encodeURI(url));
}
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 report_list_title">
                ...
                <c:forEach items="${indexList}" var="i">
					...
					<c:if test="${length>36}">
	                    ...
	                    <span class="col-md-3 col-sm-3 col-xs-6 tc p0"  >
