	...
	laypage({
	    ...
	    jump: function(e, first){ //触发分页后的回调
	        if(!first){ //一定要加此判断，否则初始时会无限刷新
	      		window.location.href="${pageContext.request.contextPath}/index/selectIndexNewsByParId.html?id="+id+"&page="+e.curr+"&title="+title;
	        }
	    }
	});
});
...
function query(){
	var title = $("#title").val();
	window.location.href="${pageContext.request.contextPath}/index/selectIndexNewsByParId.html?id="+id+"&title="+title;
}
</script>
</head>
  ...
  <!--面包屑导航开始-->
   <div class="margin-top-10 breadcrumbs">
      <div class="container">
		   ...
		   <li><a href="${pageContext.request.contextPath}/index/selectIndexNews.html">首页</a></li><li><a href="javascript:void(0)">信息公告</a></li>
		   </ul>
		<div class="clear"></div>
	  </div>
   </div>
