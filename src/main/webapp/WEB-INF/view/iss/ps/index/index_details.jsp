...
<div class="container content height-350 job-content ">
   ...
   <div class="col-md-12 p30_40 border1 margin-top-20">
	 ...
	 <div class="source" ><div class="fr"><span>文章来源：${articleDetail.source}</span><span class="ml15"><i class="mr5"><img src="${pageContext.request.contextPath}/public/protal/images/block.png"/></i><fmt:formatDate value='${articleDetail.createdAt}' pattern="yyyy.MM.dd" /></span></div></div>
