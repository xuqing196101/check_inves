        ...
        laypage({
          ...
          jump: function(e, first) { //触发分页后的回调
            if(!first) { //一定要加此判断，否则初始时会无限刷新
              location.href = '${ pageContext.request.contextPath }/article/auditlist.html?status=1&status=2&status=3&page=' + e.curr;
            }
          }
        });
      });
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="search_detail">
        <form id="form1" action="${pageContext.request.contextPath }/article/auditlist.html?status=1&status=2&status=3" method="post" class="mb0">
