  ...
  <body>
   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="javascript:void(0)"> 首页</a></li><li><a href="${ pageContext.request.contextPath }/article/getAll.html">信息管理</a></li><li><a href="javascript:void(0)">审核信息管理</a></li></ul>
		<div class="clear"></div>
	  </div>
   </div>
