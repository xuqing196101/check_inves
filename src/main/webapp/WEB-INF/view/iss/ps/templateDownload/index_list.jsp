		...
		laypage({
		    ...
		    jump: function(e, first){ //触发分页后的回调
		        if(!first){ //一定要加此判断，否则初始时会无限刷新
		      		var name = "${data.name}";
		      		location.href = "${pageContext.request.contextPath }/templateDownload/getIndexList.html?name=" + name + "&page=" + e.curr;
		        }
		    }
		});
	});
...
<body>
	      ...
	      <div class="container">
			   	<ul class="breadcrumb margin-left-0">
			   		<li><a href="${pageContext.request.contextPath}/index/selectIndexNews.html">首页</a></li><li><a href="#">采购模板下载</a></li>
			   	</ul>
					<div class="clear"></div>
		  	</div>
	   	</div>
