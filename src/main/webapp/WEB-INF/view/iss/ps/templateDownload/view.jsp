						...
						<div class="tab-content padding-top-20 over_hideen">
							<div class="tab-pane fade active in" id="tab-1">
								<table class="table table-bordered">
									<tbody>
										<tr>
											<td class="bggrey " width="15%">采购模板名称：</td>
											<td colspan="3">${data.name }</td>
											<%--<td class="bggrey " width="15%">发布范围：</td>
											<td width="35%%">
										...
										--%></tr>
										<tr>
											<td class="bggrey " width="15%">附件：</td>
											<td width="35%"><u:show showId="data_file_show"  delete="false" businessId="${data.id }" sysKey="${sysKey}" typeId="${dataTypeId }" /></td>
											<td class="bggrey " width="15%">发布时间：</td>
											<td width="35%"><fmt:formatDate value="${data.publishAt }" pattern="yyyy-MM-dd" /></td>
										</tr>
										<tr>
											<td class="bggrey " width="15%">创建时间：</td>
											<td width="35%">
												<fmt:formatDate value="${data.createdAt }" pattern="yyyy-MM-dd" />
											</td>
											<td class="bggrey" width="15%">修改时间：</td>
											<td width="35%">
