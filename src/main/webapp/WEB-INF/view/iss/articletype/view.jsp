  ...
  <body>           	   
   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="#"> 首页</a></li><li><a href="#">论坛管理</a></li><li class="active"><a href="#">栏目管理</a></li>
		   </ul>
		<div class="clear"></div>
	  </div>
   </div>
	   ...
	   <ul class="list-unstyled list-flow p0_20">
			 ...
			 <li class="col-md-6  p0 ">
			   <span class="fl">创建时间：</span>				 	
	  			<div class="">
		        <fmt:formatDate value='${articletype.createdAt}' pattern="yyyy年MM月dd日  HH:mm:ss" />
		        <%--<span class="add-on">i</span>--%>
		       </div>
			 </li>
			 <li class="col-md-6  p0 ">
			   <span class="fl">更新时间：</span>				 	
	  			<div class="">
		        <fmt:formatDate value='${articletype.updatedAt}' pattern="yyyy年MM月dd日  HH:mm:ss" />
		        <%--<span class="add-on">i</span>--%>
		       </div>
			 </li>
