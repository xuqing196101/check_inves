	   ...
	   <ul class="list-unstyled list-flow p0_20">
			 ...
			 <li class="col-md-6  p0 ">
			   <span class="fl">创建时间：</span>				 	
	  			<div class="input-append">
		        <input class="span2"  type="text" value = '${park.createdAt}' readonly="readonly"><fmt:formatDate value='${park.createdAt}' pattern="yyyy年MM月dd日  HH:mm:ss" />
		        <%--<span class="add-on">i</span>--%>
		       </div>
			 </li>
			 <li class="col-md-6  p0 ">
			   <span class="fl">更新时间：</span>				 	
	  			<div class="input-append">
		        <input class="span2"  type="text" value = '${park.updatedAt}' readonly="readonly"><fmt:formatDate value='${park.updatedAt}' pattern="yyyy年MM月dd日  HH:mm:ss" />
		        <%--<span class="add-on">i</span>--%>
		       </div>
			 </li>
