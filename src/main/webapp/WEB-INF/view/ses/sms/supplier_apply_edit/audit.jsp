...
<script type="text/javascript">
   ...
   function shenhe(str){
		if(str=='tongguo'){
		    ...
		    layer.confirm('您确定要退回吗?', {title:'提示',offset: ['122px','360px'],shade:0.01}, function(index){
				//layer.close(index);
	...
	function out(text){
		layer.msg("修改之前是："+text,{offset:'200px'});
	}
</script>
</head>
    <body>
        ...
        <div class="margin-top-10 breadcrumbs ">
            <div class="container">
                <ul class="breadcrumb margin-left-0">
                    <li><a href="#"> 首页</a></li><li><a href="#">供应商个人信息</a></li><li><a href="#">供应商审核</a></li>
                </ul>
            </div>
        </div> 
            ...
            <div class=" content height-350">
                <div class="col-md-12 tab-v2 job-content">
	                    ...
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                         <c:if test="${not empty result.supplierName }">
								 <input class="span5" id="supplierName3" onclick="out('${result.supplierName}')"   value="${currSupplier.supplierName }" type="text">
								 <div id="supplierName" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
							 </c:if>
						     <c:if test="${ empty result.supplierName }">
								 <input class="span5"  readonly value="${currSupplier.supplierName }" type="text">
							 </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                           <c:if test="${not empty result.website }">
						       		<input class="span5" id="website3" type="text" readonly  onclick="out('${result.website}')" value="${currSupplier.website}">
						       		<div id="website" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
						       </c:if>
						       <c:if test="${empty result.website }">
						       		<input class="span5" type="text" readonly value="${currSupplier.website}">
						       </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                            <c:if test="${not empty result.foundDate }">
						             <input class="span5" id="foundDate3" type="text" readonly onClick="WdatePicker()" 
						             onclick="out('<fmt:formatDate value="${result.foundDate}" pattern="yyyy-MM-dd"  />')"
							             value="<fmt:formatDate value="${currSupplier.foundDate}" pattern="yyyy-MM-dd"  />" />
							         <div id="foundDate" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
					            </c:if>
					            <c:if test="${empty result.foundDate }">
					            	 <input class="span5" type="text" readonly onClick="WdatePicker()" 
						       	     value="<fmt:formatDate value="${currSupplier.foundDate}" pattern="yyyy-MM-dd"  />" />
					            </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                            <c:if test="${not empty result.businessType }">
						             <input class="span5" type="text" id="businessType3" readonly  onclick="out('${result.businessType}')"  value="${currSupplier.businessType}" />
							         <div id=businessType onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
					            </c:if>
					            <c:if test="${empty result.businessType }">
					            	 <input class="span5" type="text" readonly value="${currSupplier.businessType}"/>
					            </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                            <c:if test="${not empty result.address }">
						             <input class="span5" id="address3" type="text" readonly  onclick="out('${result.address}')"  value="${currSupplier.address}" />
							         <div id="address" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
					            </c:if>
					            <c:if test="${empty result.address }">
					            	 <input class="span5" type="text" readonly value="${currSupplier.address}"/>
					            </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                            <c:if test="${not empty result.bankName }">
						             <input class="span5" id="bankName3" type="text" readonly onclick="out('${result.bankName}')"  value="${currSupplier.bankName}" />
							         <div id="bankName" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
					            </c:if>
					            <c:if test="${empty result.bankName }">
					            	 <input class="span5" type="text" readonly value="${currSupplier.bankName}"/>
					            </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                            <c:if test="${not empty result.bankAccount }">
						             <input class="span5" id="bankAccount3" type="text" readonly onclick="out('${result.bankAccount}')"  value="${currSupplier.bankAccount}" />
							         <div id="bankAccount" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
					            </c:if>
					            <c:if test="${empty result.bankAccount }">
					            	 <input class="span5" type="text" readonly value="${currSupplier.bankAccount}"/>
					            </c:if>
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="postCode2">邮编：</span>
	                       <div class="input-append">
	                            <c:if test="${not empty result.postCode }">
						             <input class="span5" id="postCode3" type="text" readonly onclick="out('${result.postCode}')"  value="${currSupplier.postCode}" />
							         <div id="postCode" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
					            </c:if>
					            <c:if test="${empty result.postCode }">
					            	 <input class="span5" type="text" readonly value="${currSupplier.postCode}"/>
					            </c:if>
	                       </div>
	                   </li>
                   </ul>
                  ...
                  <ul class="ul_list hand">
                    <li class="col-md-3 margin-0 padding-0 "><span class="hand" onclick="reason1(this,'taxCert');" onclick="this.style.border='solid 1px #FF0000'" onmouseout="this.style.border='solid 1px #FFFFFF'" >近三个月完税凭证：</span>
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="hand" onclick="reason1(this,'billCert');" onclick="this.style.border='solid 1px #FF0000'" onmouseout="this.style.border='solid 1px #FFFFFF'" >近三年银行基本账户年末对账单：</span>
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="hand" onclick="reason1(this,'securityCert');" onclick="this.style.border='solid 1px #FF0000'" onmouseout="this.style.border='solid 1px #FFFFFF'" >近三个月缴纳社会保险金凭证：</span>
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="hand" onclick="reason1(this,'breachCert');" onclick="this.style.border='solid 1px #FF0000'" onmouseout="this.style.border='solid 1px #FFFFFF'" >近三年内无重大违法记录声明：</span>
                    ...
                    <li class="col-md-3 margin-0 padding-0 ">
                        ...
                        <div class="input-append">
                            <c:if test="${not empty result.legalName }">
					             <input class="span5" id="legalName3" type="text" readonly onclick="out('${result.legalName}')"  value="${currSupplier.legalName}" />
						         <div id="legalName" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
				            </c:if>
				            <c:if test="${empty result.legalName }">
				            	 <input class="span5" type="text" readonly value="${currSupplier.legalName}"/>
				            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="legaIdCard2">身份证号：</span>
                        <div class="input-append">
	                        <c:if test="${not empty result.legalIdCard }">
					             <input class="span5" id="legalIdCard3" type="text" onclick="out('${result.legalIdCard}')" readonly  value="${currSupplier.legalIdCard}" />
						         <div id="legalIdCard" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
				            </c:if>
				            <c:if test="${empty result.legalIdCard }">
				            	 <input class="span5" type="text" readonly value="${currSupplier.legalIdCard}"/>
				            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="legalTelephone2">固定电话：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.legalTelephone }">
				             <input class="span5" id="legalTelephone3" type="text" onclick="out('${result.legalTelephone}')" readonly  value="${currSupplier.legalTelephone}" />
					         <div id="legalTelephone" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.legalTelephone }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.legalTelephone}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="legalMobile2">手机：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.legalMobile }">
				             <input class="span5" id="legalMobile3" type="text" onclick="out('${result.legalMobile}')" readonly  value="${currSupplier.legalMobile}" />
					         <div id="legalMobile" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.legalMobile }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.legalMobile}"/>
			            </c:if>
                      </div>
                    </li>
                  </ul>
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="contactName2">姓名：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.contactName }">
				             <input class="span5" id="contactName3" type="text" onclick="out('${result.contactName}')" readonly  value="${currSupplier.contactName}" />
					         <div id="contactName" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.contactName }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.contactName}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="contactFax2">传真：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.contactFax }">
				             <input class="span5" id="contactFax3" type="text" onclick="out('${result.contactFax}')" readonly  value="${currSupplier.contactFax}" />
					         <div id="contactFax" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.contactFax }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.contactFax}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="contactTelephone1">固定电话：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.contactTelephone }">
				             <input class="span5" id="contactTelephone3" type="text"  onclick="out('${result.contactTelephone}')" readonly  value="${currSupplier.contactTelephone}" />
					         <div id="contactTelephone" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.contactTelephone }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.contactTelephone}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="contactMobile2">手机：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.contactMobile }">
				             <input class="span5" id="contactMobile3" type="text" onclick="out('${result.contactMobile}')" readonly  value="${currSupplier.contactMobile}" />
					         <div id="contactMobile" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.contactMobile }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.contactMobile}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="contactEmail2">邮箱：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.contactEmail }">
				             <input class="span5" id="contactEmail3" type="text" readonly onclick="out('${result.contactEmail}')"  value="${currSupplier.contactEmail}" />
					         <div id="contactEmail3" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.contactEmail }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.contactEmail}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="contactAddress2">地址：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.contactAddress }">
				             <input class="span5" id="contactAddress3" type="text" readonly onclick="out('${result.contactAddress}')"  value="${currSupplier.contactAddress}" />
					         <div id="contactAddress" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.contactAddress }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.contactAddress}"/>
			            </c:if>
                      </div>
                    </li>
                  </ul>
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="creditCode2">统一社会信用代码：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.creditCode }">
				             <input class="span5" id="creditCode3" type="text" readonly  onclick="out('${result.creditCode}')"  value="${currSupplier.creditCode}" />
					         <div id="creditCode" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.creditCode }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.creditCode}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="registAuthority2">登记机关：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.registAuthority }">
				             <input class="span5" id="registAuthority3" type="text" readonly onclick="out('${result.registAuthority}')"  value="${currSupplier.registAuthority}" />
					         <div id="registAuthority" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.registAuthority }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.registAuthority}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="registFund2">注册资本：</span>
                      <div class="input-append">
                       <c:if test="${not empty result.registFund }">
				             <input class="span5" id="registFund3" type="text" readonly onclick="out('${result.registFund}')"  value="${currSupplier.registFund}" />
					         <div id="registFund" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.registFund }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.registFund}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="businessEndDate2">营业开始时间：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.businessStartDate }">
				             <input class="span5" id="businessStartDate3" type="text" readonly 
				               onclick="out('<fmt:formatDate value="${currSupplier.businessStartDate}" pattern="yyyy-MM-dd" />')"
				               value="<fmt:formatDate value="${currSupplier.businessStartDate}" pattern="yyyy-MM-dd" />" />
					         <div id="businessStartDate" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.businessStartDate }">
			            	 <input class="span5" type="text" readonly value="<fmt:formatDate value="${currSupplier.businessStartDate}" pattern="yyyy-MM-dd" />"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="businessStartDate2">营业截止时间：</span>
                      <div class="input-append">
                       <c:if test="${not empty result.businessEndDate }">
				             <input class="span5" id="businessEndDate3" type="text" readonly
				               onclick="out('<fmt:formatDate value="${currSupplier.businessEndDate}" pattern="yyyy-MM-dd" />')"
				               value="<fmt:formatDate value="${currSupplier.businessEndDate}" pattern="yyyy-MM-dd" />" />
					         <div id="businessEndDate" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.businessEndDate }">
			            	 <input class="span5" type="text" readonly value="<fmt:formatDate value="${currSupplier.businessEndDate}" pattern="yyyy-MM-dd" />"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="fl" id="businessAddress2">生产或经营地址：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.businessAddress }">
				             <input class="span5" id="businessAddress3" type="text" readonly onclick="out('${result.businessAddress}')"  value="${currSupplier.businessAddress}" />
					         <div id="businessAddress" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.businessAddress }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.businessAddress}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="businessPostCode2">邮编：</span>
                      <div class="input-append">
                         <c:if test="${not empty result.businessPostCode }">
				             <input class="span5" id="businessPostCode3" type="text" readonly onclick="out('${result.businessPostCode}')"  value="${currSupplier.businessPostCode}" />
					         <div id="businessPostCode" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.businessPostCode }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.businessPostCode}"/>
			            </c:if>
                      </div>
                    </li>
                    ...
                    <li class="col-md-11 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="businessScope2">经营范围：</span>
                        <div class="input-append">
                            <c:if test="${not empty result.businessScope }">
					             <input class="span5" id="businessScope3" type="text" readonly onclick="out('${result.businessScope}')"  value="${currSupplier.businessScope}" />
						         <div id="businessScope" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
				            </c:if>
				            <c:if test="${empty result.businessScope }">
				            	 <input class="span5" type="text" readonly value="${currSupplier.businessScope}"/>
				            </c:if>
                      </div>
                    </li>
                  </ul>
                      ...
                      <div class="input-append">
                         <c:if test="${not empty result.overseasBranch }">
				             <c:if test="${currSupplier.overseasBranch==0 }">
				             	<input class="span5" id="overseasBranch3" type="text" onclick="out('${result.overseasBranch}')" readonly  value="无" />
				             </c:if>
				             <c:if test="${currSupplier.overseasBranch==1 }">
				             	<input class="span5" id="overseasBranch3" type="text" onclick="out('${result.overseasBranch}')" readonly  value="有" />
				             </c:if>
					         <div id="overseasBranch" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			             </c:if>
			             <c:if test="${empty result.overseasBranch }">
			            	 <c:if test="${currSupplier.overseasBranch==0 }">
				             	<input class="span5" id="overseasBranch3" type="text" readonly  value="无" />
				             </c:if>
				             <c:if test="${currSupplier.overseasBranch==1 }">
				             	<input class="span5" id="overseasBranch3" type="text" readonly  value="有" />
				             </c:if>
			             </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="branchCountry2">境外分支所在国家：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.branchCountry }">
				             <input class="span5" id="branchCountry3" type="text" readonly onclick="out('${result.branchCountry}')"  value="${currSupplier.branchCountry}" />
					         <div id="branchCountry" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.branchCountry }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.branchCountry}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="branchAddress2">分支地址：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.branchAddress }">
				             <input class="span5" id="branchAddress3" type="text" readonly onclick="out('${result.branchAddress}')"  value="${currSupplier.branchAddress}" />
					         <div id="branchAddress" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.branchAddress }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.branchAddress}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-3 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="branchName2">机构名称：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.branchName }">
				             <input class="span5" id="branchName3" type="text" readonly onclick="out('${result.branchName}')"  value="${currSupplier.branchName}" />
					         <div id="branchName" onclick="reason(this)" class="b f18 fl ml10 hand red">×</div>
			            </c:if>
			            <c:if test="${empty result.branchAddress }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.branchName}"/>
			            </c:if>
                      </div>
                    </li>
                    <li class="col-md-11 margin-0 padding-0 "><span class="col-md-12 padding-left-5" id="branchBusinessScope2">分支生产经营范围：</span>
                      <div class="input-append">
                        <c:if test="${not empty result.branchBusinessScope }">
				             <input class="span5" id="branchBusinessScope3" type="text" readonly  onclick="out('${result.branchBusinessScope}')" value="${currSupplier.branchBusinessScope}" />
			            ...
			            <c:if test="${empty result.branchBusinessScope }">
			            	 <input class="span5" type="text" readonly value="${currSupplier.branchBusinessScope}"/>
			            </c:if>
                      </div>
                    </li>
                  </ul>
