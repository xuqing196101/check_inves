                ...
                <div class="col-md-12 tab-v2 job-content">
                    ...
                    <ul class="ul_list">
	                    ...
	                    <li class="col-md-3 margin-0 padding-0 ">
	                       ...
	                       <div class="input-append">
	                           <input type="hidden" name="foundDate" value="${supplier.foundDate}" />
	                           <input class="span5" id="foundDate" value="<fmt:formatDate value='${supplier.foundDate}' pattern='yyyy-MM-dd'/>"   type="text">
	                       </div>
	                    </li>
	                    <li class="col-md-3 margin-0 padding-0 ">
                  ...
                  <ul class="ul_list">
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="" id="legaIdCard2">身份证号：</span>
                        <div class="input-append">
                        <input class="span5" id="legaIdCard" name="legaIdCard" value="${supplier.legalIdCard } "  type="text">
                      </div>
                    </li>
                  ...
                  <ul class="ul_list">
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="" id="businessEndDate2">营业开始时间：</span>
                      <div class="input-append">
                      <input type="hidden" value="${supplier.businessStartDate}" name="businessStartDate" />
                        <input  id="businessStartDate" class="Wdate w230" onclick='WdatePicker()' 
                    ...
                    <li class="col-md-3 margin-0 padding-0 "><span class="" id="businessStartDate2">营业截止时间：</span>
                      <div class="input-append">
                       <input type="hidden" value="${supplier.businessEndDate}" name="businessEndDate" />
                       <input  id="businessEndDate"  class="Wdate w230" onclick="WdatePicker()" 
