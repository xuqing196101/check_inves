      ...
      <div class="col-md-12 tab-v2 job-content">
        <div class="padding-top-10">
          <ul class="nav nav-tabs bgdd">
			<li class=""><a aria-expanded="true" href="#tab-1" data-toggle="tab" id="essential"  onclick="window.location.href='${pageContext.request.contextPath}/supplier_edit/auditView.html?id=${supplierId }'" >基本信息</a></li>
