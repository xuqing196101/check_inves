          ...
          <div class="col-md-12 tab-v2 job-content">
            ...
            <ul class="count_flow ul_list hand">
              <%-- <li class="col-md-3 margin-0 padding-0 ">
                ...
                <span class="col-md-5 padding-left-5" onclick="reason1(this,'supplierRegList');" >供应商申请表：</span>
	            ...
	            <li class="col-md-6 mt10 mb25" >
	              <span class="col-md-5 padding-left-5" onclick="reason1(this,'supplierPledge');" >供应商承诺书：</span>
