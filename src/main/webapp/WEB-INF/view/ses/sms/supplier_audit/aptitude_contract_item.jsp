            ...
            <table class="table table-bordered m_table_fixed_border m_table_fixed_border">
                ...
                <c:forEach items="${contract}" var="obj" varStatus="vs">
                    <tr>
                        ...
                        <td class="m_upload_file" id="td1${vs.index + 1}" <c:if test="${fn:contains(fileModifyField,obj.supplierItemId.concat(obj.oneContract))}">style="border: 1px solid #FF8C00;"</c:if>>
                        ...
                        <td class="m_upload_file" id="td1${vs.index + 2}" <c:if test="${fn:contains(fileModifyField,obj.supplierItemId.concat(obj.twoContract))}">style="border: 1px solid #FF8C00;"</c:if>>
                        ...
                        <td class="m_upload_file" id="td1${vs.index + 3}" <c:if test="${fn:contains(fileModifyField,obj.supplierItemId.concat(obj.threeContract))}">style="border: 1px solid #FF8C00;"</c:if>>
                        ...
                        <td class="m_upload_file" id="td1${vs.index + 4}" <c:if test="${fn:contains(fileModifyField,obj.supplierItemId.concat(obj.oneBil))}">style="border: 1px solid #FF8C00;"</c:if>>
                        ...
                        <td class="m_upload_file" id="td1${vs.index + 5}" <c:if test="${fn:contains(fileModifyField,obj.supplierItemId.concat(obj.twoBil))}">style="border: 1px solid #FF8C00;"</c:if>>
                        ...
                        <td class="m_upload_file" id="td1${vs.index + 6}" <c:if test="${fn:contains(fileModifyField,obj.supplierItemId.concat(obj.threeBil))}">style="border: 1px solid #FF8C00;"</c:if>>
