    ...
    <div class="content ">
        <div class="col-md-12 tab-v2 job-content">
            ...
            <div class="tab-content padding-top-20 tab-pane fade display-none" id="tab_1">
                <div class="mb10">
                    <c:if test="${isAudit}">
                        <button class="btn btn-windows cancel" type="button" onclick="auditCategory('content_1');">不通过
                        </button>
                        <button class="btn btn-windows cancel" type="button" onclick="auditContract('content_1');">
                            退回合同
                        </button>
                        <button class="btn btn-windows edit" type="button" onclick="updateAudit('content_1');">更新审核
                        </button>
                    </c:if>
                </div>
                <table class="table table-bordered table-condensed table-hover m_table_fixed_border" id="content_1">
                    <thead>
                    <tr>
                        <th class="w50 info"><input id="content_1checkAll" type="checkbox"
                                                    onclick="selectAll('content_1')"/></th>
            ...
            <div class="tab-content padding-top-20 tab-pane fade display-none" id="tab_2">
                <div class="mb10">
                    <c:if test="${isAudit}">
                        <button class="btn btn-windows cancel" type="button" onclick="auditCategory('content_2');">不通过
                        </button>
                        <button class="btn btn-windows cancel" type="button" onclick="auditContract('content_2');">
                            退回合同
                        </button>
                        <button class="btn btn-windows edit" type="button" onclick="updateAudit('content_2');">更新审核
                        </button>
                    </c:if>
                </div>
                <table class="table table-bordered table-condensed table-hover m_table_fixed_border" id="content_2">
                    ...
                    <thead>
                    <tr>
                        <th class="w50 info"><input id="content_2checkAll" type="checkbox"
                                                    onclick="selectAll('content_2')"/></th>
                        <td class="tc info">序号</td>
                        <td class="tc info">类别</td>
                        <td class="tc info">大类</td>
                        <td class="tc info">中类</td>
            ...
            <div class="tab-content padding-top-20 tab-pane fade display-none" id="tab_3">
                <div class="mb10">
                    <c:if test="${isAudit}">
                        <button class="btn btn-windows cancel" type="button" onclick="auditCategory('content_3');">不通过
                        </button>
                        <button class="btn btn-windows edit" type="button" onclick="updateAudit('content_3');">更新审核
                        </button>
                    </c:if>
                </div>
                <table class="table table-bordered table-condensed table-hover m_table_fixed_border" id="content_3">
                    <thead>
                    <tr>
                        <th class="w50 info"><input id="content_3checkAll" type="checkbox"
                                                    onclick="selectAll('content_3')"/></th>
                        <td class="tc info">序号</td>
                        <td class="tc info">类别</td>
                        <td class="tc info">大类</td>
                        <td class="tc info">中类</td>
            ...
            <div class="tab-content padding-top-20 tab-pane fade display-none" id="tab_4">
                <div class="mb10">
                    <c:if test="${isAudit}">
                        <button class="btn btn-windows cancel" type="button" onclick="auditCategory('content_4');">不通过
                        </button>
                        <button class="btn btn-windows cancel" type="button" onclick="auditContract('content_4');">
                            退回合同
                        </button>
                        <button class="btn btn-windows edit" type="button" onclick="updateAudit('content_4');">更新审核
                        </button>
                    </c:if>
                </div>
                <table class="table table-bordered table-condensed table-hover m_table_fixed_border" id="content_4">
                    <thead>
                    <tr>
                        <th class="w50 info"><input id="content_4checkAll" type="checkbox"
                                                    onclick="selectAll('content_4')"/></th>
                        <td class="tc info">序号</td>
                        <td class="tc info">类别</td>
                        <td class="tc info">大类</td>
                        <td class="tc info">中类</td>
