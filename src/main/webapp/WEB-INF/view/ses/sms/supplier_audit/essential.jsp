	              ...
	              <a aria-expanded="false" href="#tab-4" >产品信息</a>
	               <i></i>
					...
					<ul class="ul_list hand">
						<li class="col-md-3 col-sm-6 col-xs-12 pl15"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5" id="postCode2">注册地址邮编：</span>
							<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
						...
						<li class="col-md-3 col-sm-6 col-xs-12">
							...
							<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
								<input id="address" class="hand " value="${parentAddress}${sonAddress } " type="text" onclick="reason(this.id,'address')" <c:if test="${fn:contains(field,'address')}">onMouseOver="isCompare('address');"</c:if>>
								<div id="address3" class="abolish">×</div>
							</div>
						</li>
						<li class="col-md-3 col-sm-6 col-xs-12">
							<span class="col-md-12 col-xs-12 col-sm-12 padding-left-5" id="detailAddress2">注册公司详细地址：</span>
							<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
           		...
           		<p class="b f18 ml10 red">×</p>
					...
					<ul class="ul_list">
						...
						<li class="col-md-3 col-sm-6 col-xs-12">
							<span class="col-md-12 col-sm-12 col-xs-12 padding-left-5" id="contactAddress2">详细地址：</span>
							<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0 col-md-12 col-sm-12 col-xs-12 p0">
