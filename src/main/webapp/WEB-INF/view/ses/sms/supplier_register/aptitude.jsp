				...
				<div class="col-md-12 tab-v2 job-content">
					<div class="padding-top-10" >
						<ul id="page_ul_id" class="nav nav-tabs bgdd supplier_tab">
								...
								<li id="li_id_1" class="active"><a aria-expanded="true" href="#tab-3" data-toggle="tab" class="f18">通用</a></li>
						 
								<li id="li_id_2" class=""><a aria-expanded="false" href="#tab-4" data-toggle="tab" class=" f18">专用</a></li>
						...
						<%-- 	<c:if test="${fn:contains(currSupplier.supplierTypeIds, 'PRODUCT')}"> --%>
								<!-- 物资生产型 -->
								<div class="tab-pane fade active in height-300" id="">
									<h2 class="f16 ">
											通用
									</h2>
