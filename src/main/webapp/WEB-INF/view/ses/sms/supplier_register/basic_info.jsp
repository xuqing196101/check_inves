							...
							<ul class="list-unstyled f14">
								...
								<li class="col-md-3 col-sm-6 col-xs-12">
									...
									<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
										...
										<input type="text" readonly="readonly" name="foundDate" value="${foundDate}" <c:if test="${fn:contains(audit,'foundDate')&&currSupplier.status==2}">onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'{%y-3}-%M-%d'})" </c:if> <c:if test="${fn:contains(audit,'foundDate')}">style="border: 1px solid red;" onmouseover="errorMsg('foundDate')"</c:if> />
										<span class="add-on cur_point">i</span>
							...
							<ul class="list-unstyled f14">
								...
								<li class="col-md-3 col-sm-6 col-xs-12">
									...
									<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
										...
										<input id="expireDate" type="text" readonly="readonly" onClick="WdatePicker()" name="businessStartDate" value="<fmt:formatDate value="${currSupplier.businessStartDate}" pattern="yyyy-MM-dd" var="businessStartDate" />" <c:if test="${fn:contains(audit,'businessStartDate')}">style="border: 1px solid red;" onmouseover="errorMsg('businessStartDate')"</c:if>/>
										<span class="add-on cur_point">i</span>
