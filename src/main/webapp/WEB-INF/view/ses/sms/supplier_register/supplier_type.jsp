		    ...
		    <div class="col-md-5 col-sm-6 col-xs-6 title tr"></div> 
			  <div class="col-md-7 col-sm-6 col-xs-12 service_list">
			       <c:forEach items="${wlist }" var="obj" >
					    <span <c:if test="${fn:contains(typePageField,obj.id)}">style="color: red;" onmouseover="errorMsg('${obj.id }','supplierType_page')"</c:if>><input type="checkbox" name="chkItem" onclick="checks(this)"  value="${obj.code}" /> ${obj.name }</span>
			      </c:forEach>
										...
										<legend> 组织机构和人员信息 </legend>
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 组织机构：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input id="supplierName_input_id" type="text" required  maxlength="20" name="supplierMatPro.orgName" value="${currSupplier.supplierMatPro.orgName}" <c:if test="${fn:contains(proPageField,'orgName')}">style="border: 1px solid red;" onmouseover="errorMsg('orgName','mat_pro_page')"</c:if>/>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 人员总数：</span>
													<div class="input-append co-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.totalPerson" required onkeyup="checknums(this)"  value="${currSupplier.supplierMatPro.totalPerson}" <c:if test="${fn:contains(proPageField,'totalPerson')}">style="border: 1px solid red;" onmouseover="errorMsg('totalPerson','mat_pro_page')"</c:if>/>
													   <span class="add-on cur_point">i</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 管理人员数量：</span>
													<div class="input-append co-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.totalMange" onkeyup="checknums(this)"  required value="${currSupplier.supplierMatPro.totalMange}" <c:if test="${fn:contains(proPageField,'totalMange')}">style="border: 1px solid red;" onmouseover="errorMsg('totalMange','mat_pro_page')"</c:if>/>
												     	<span class="add-on cur_point">i</span>
												     	<span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 技术人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.totalTech" onkeyup="checknums(this)"  required value="${currSupplier.supplierMatPro.totalTech}" <c:if test="${fn:contains(proPageField,'totalTech')}">style="border: 1px solid red;" onmouseover="errorMsg('totalTech','mat_pro_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
						            ...
						            <fieldset class="col-md-12 col-sm-12 col-xs-12 border_font mt20">
										...
										<!-- 	<ul class="list-unstyled list-flow"> -->
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 技术人员数量比例(%)：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.scaleTech" required value="${currSupplier.supplierMatPro.scaleTech}" <c:if test="${fn:contains(proPageField,'scaleTech')}">style="border: 1px solid red;" onmouseover="errorMsg('scaleTech','mat_pro_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 高级技术人员数量比例(%)：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.scaleHeightTech" required value="${currSupplier.supplierMatPro.scaleHeightTech}" <c:if test="${fn:contains(proPageField,'scaleHeightTech')}">style="border: 1px solid red;" onmouseover="errorMsg('scaleHeightTech','mat_pro_page')"</c:if>/>
													   <span class="add-on cur_point">i</span>
													   <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 研发部门名称：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.researchName" required maxlength="20" value="${currSupplier.supplierMatPro.researchName}" <c:if test="${fn:contains(proPageField,'researchName')}">style="border: 1px solid red;" onmouseover="errorMsg('researchName','mat_pro_page')"</c:if>/>
													   <span class="add-on cur_point">i</span>
													   <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 研发部门人数：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.totalResearch"  required  onkeyup="checknums(this)" value="${currSupplier.supplierMatPro.totalResearch}" <c:if test="${fn:contains(proPageField,'totalResearch')}">style="border: 1px solid red;" onmouseover="errorMsg('totalResearch','mat_pro_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 研发部门负责人：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.researchLead"  required maxlength="20" value="${currSupplier.supplierMatPro.researchLead}" <c:if test="${fn:contains(proPageField,'researchLead')}">style="border: 1px solid red;" onmouseover="errorMsg('researchLead','mat_pro_page')"</c:if>/>
													   <span class="add-on cur_point">i</span>
													   <span class="input-tip">不能为空</span>
										...
										<fieldset class="col-md-12 col-sm-12 col-xs-12 border_font mt20">
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 生产线数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.totalBeltline" required onkeyup="checknums(this)" value="${currSupplier.supplierMatPro.totalBeltline}" <c:if test="${fn:contains(proPageField,'totalBeltline')}">style="border: 1px solid red;" onmouseover="errorMsg('totalBeltline','mat_pro_page')"</c:if>/>
														   <span class="add-on cur_point">i</span>
														   <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 生产设备数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.totalDevice" required onkeyup="checknums(this)" value="${currSupplier.supplierMatPro.totalDevice}" <c:if test="${fn:contains(proPageField,'totalDevice')}">style="border: 1px solid red;" onmouseover="errorMsg('totalDevice','mat_pro_page')"</c:if>/>
													  	   <span class="add-on cur_point">i</span>
													  	   <span class="input-tip">不能为空，且为数字</span>
											...
											<fieldset class="col-md-12 col-sm-12 col-xs-12 border_font mt20">
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 质量检测部门：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.qcName" required maxlength="20" value="${currSupplier.supplierMatPro.qcName}" <c:if test="${fn:contains(proPageField,'qcName')}">style="border: 1px solid red;" onmouseover="errorMsg('qcName','mat_pro_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 质量部门人数：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
													 	<input type="text" name="supplierMatPro.totalQc" required onkeyup="checknums(this)" value="${currSupplier.supplierMatPro.totalQc}" <c:if test="${fn:contains(proPageField,'totalQc')}">style="border: 1px solid red;" onmouseover="errorMsg('totalQc','mat_pro_page')"</c:if>/>
													  <span class="add-on cur_point">i</span>
													  <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 质监部门负责人：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.qcLead" required maxlength="20" value="${currSupplier.supplierMatPro.qcLead}" <c:if test="${fn:contains(proPageField,'qcLead')}">style="border: 1px solid red;" onmouseover="errorMsg('qcLead','mat_pro_page')"</c:if>/>
														 <span class="add-on cur_point">i</span>
														 <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 质量检测设备名称：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatPro.qcDevice" required maxlength="20" value="${currSupplier.supplierMatPro.qcDevice}" <c:if test="${fn:contains(proPageField,'qcDevice')}">style="border: 1px solid red;" onmouseover="errorMsg('qcDevice','mat_pro_page')"</c:if> />
												     <span class="add-on cur_point">i</span>
												     <span class="input-tip">不能为空</span>
								        ...
								        <fieldset class="col-md-12 col-sm-12 col-xs-12 border_font">
	 			 						     <legend> 组织机构和人员信息  </legend>
												<li class="col-md-3 col-sm-6 col-xs-12 pl10"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 组织机构：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSell.orgName" required maxlength="20" value="${currSupplier.supplierMatSell.orgName}" <c:if test="${fn:contains(sellPageField,'orgName')}">style="border: 1px solid red;" onmouseover="errorMsg('orgName','mat_sell_page')"</c:if>/>
														 <span class="add-on cur_point">i</span>
														 <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 人员总数：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSell.totalPerson" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSell.totalPerson}" <c:if test="${fn:contains(sellPageField,'totalPerson')}">style="border: 1px solid red;" onmouseover="errorMsg('totalPerson','mat_sell_page')"</c:if>/>
														 <span class="add-on cur_point">i</span>
														 <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 管理人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSell.totalMange" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSell.totalMange}" <c:if test="${fn:contains(sellPageField,'totalMange')}">style="border: 1px solid red;" onmouseover="errorMsg('totalMange','mat_sell_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 技术人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSell.totalTech" required onkeyup="checknums(this)"  value="${currSupplier.supplierMatSell.totalTech}" <c:if test="${fn:contains(sellPageField,'totalTech')}">style="border: 1px solid red;" onmouseover="errorMsg('totalTech','mat_sell_page')"</c:if>/>
														   <span class="add-on cur_point">i</span>
														   <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 工人（职员）数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSell.totalWorker" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSell.totalWorker}" <c:if test="${fn:contains(sellPageField,'totalWorker')}">style="border: 1px solid red;" onmouseover="errorMsg('totalWorker','mat_sell_page')"</c:if>/>
														   <span class="add-on cur_point">i</span>
														   <span class="input-tip">不能为空，且为数字</span>
									   ...
									   <!--   <div class="col-md-5 title"><span class="star_red fl">*</span>工程专业信息：</div> -->
										...
										<input type="hidden" name="supplierMatEng.supplierId" value="${currSupplier.id}" />
										    ...
										    <ul class="list-unstyled overflow_h">
												<li class="col-md-3 col-sm-6 col-xs-12 pl10"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 组织机构：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatEng.orgName" required maxlength="20" value="${currSupplier.supplierMatEng.orgName}" <c:if test="${fn:contains(engPageField,'orgName')}">style="border: 1px solid red;" onmouseover="errorMsg('orgName','mat_eng_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 技术负责人数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatEng.totalTech" required onkeyup="checknums(this)" value="${currSupplier.supplierMatEng.totalTech}" <c:if test="${fn:contains(engPageField,'totalTech')}">style="border: 1px solid red;" onmouseover="errorMsg('totalTech','mat_eng_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 中级以上职称人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatEng.totalGlNormal" required onkeyup="checknums(this)" value="${currSupplier.supplierMatEng.totalGlNormal}" <c:if test="${fn:contains(engPageField,'totalGlNormal')}">style="border: 1px solid red;" onmouseover="errorMsg('totalGlNormal','mat_eng_page')"</c:if>/>
												        <span class="add-on cur_point">i</span>
												        <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 现场管理人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatEng.totalMange" required onkeyup="checknums(this)"  value="${currSupplier.supplierMatEng.totalMange}" <c:if test="${fn:contains(engPageField,'totalMange')}">style="border: 1px solid red;" onmouseover="errorMsg('totalMange','mat_eng_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 技术和工人数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatEng.totalTechWorker" required onkeyup="checknums(this)" value="${currSupplier.supplierMatEng.totalTechWorker}" <c:if test="${fn:contains(engPageField,'totalTechWorker')}">style="border: 1px solid red;" onmouseover="errorMsg('totalTechWorker','mat_eng_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
									    ...
									    <fieldset class="col-md-12 col-sm-12 col-xs-12 border_font mt10">
										  	...
										  	<ul class="list-unstyled overflow_h">
												<li class="col-md-3 col-sm-6 col-xs-12 pl10"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5" <c:if test="${fn:contains(engPageField,'supplierConAch')}">style="border: 1px solid red;" onmouseover="errorMsg('supplierConAch','mat_eng_page')"</c:if>><i class="red">*</i> 承包合同主要页及保密协议：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
												...
												<tbody id="reg_person_list_tbody_id">
													...
													<c:forEach items="${currSupplier.supplierMatEng.listSupplierRegPersons}" var="regPerson" varStatus="vs">
														<tr <c:if test="${fn:contains(engPageField,regPerson.id)}"> onmouseover="errorMsg('${regPerson.id}','mat_eng_page')"</c:if>>
															<td class="tc" <c:if test="${fn:contains(engPageField,regPerson.id)}">style="border: 1px solid red;" </c:if>>
															...
															<td class="tc" <c:if test="${fn:contains(engPageField,regPerson.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierRegPersons[${certPersonNumber}].regType" value="${regPerson.regType}"/></td>
															<td class="tc" <c:if test="${fn:contains(engPageField,regPerson.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierRegPersons[${certPersonNumber}].regNumber" value="${regPerson.regNumber}"/></td>
														</tr>
												...
												<tbody id="aptitute_list_tbody_id">
													...
													<c:forEach items="${currSupplier.supplierMatEng.listSupplierAptitutes}" var="aptitute" varStatus="vs">
														<tr <c:if test="${fn:contains(engPageField,aptitute.id)}"> onmouseover="errorMsg('${aptitute.id}','mat_eng_page')"</c:if>>
															...
															<td class="tc" <c:if test="${fn:contains(engPageField,aptitute.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierAptitutes[${certAptNumber}].certType" value="${aptitute.certType}"/></td>
															<td class="tc" <c:if test="${fn:contains(engPageField,aptitute.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierAptitutes[${certAptNumber}].certCode" value="${aptitute.certCode}"/></td>
															<td class="tc" <c:if test="${fn:contains(engPageField,aptitute.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierAptitutes[${certAptNumber}].aptituteSequence" value="${aptitute.aptituteSequence}"/></td>
															<td class="tc" <c:if test="${fn:contains(engPageField,aptitute.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierAptitutes[${certAptNumber}].professType" value="${aptitute.professType}"/></td>
															<td class="tc" <c:if test="${fn:contains(engPageField,aptitute.id)}">style="border: 1px solid red;" </c:if>><input type="text" required="required" class="border0" name="supplierMatEng.listSupplierAptitutes[${certAptNumber}].aptituteLevel" value="${aptitute.aptituteLevel}"/></td>
															<td class="tc" <c:if test="${fn:contains(engPageField,aptitute.id)}">style="border: 1px solid red;" </c:if>>
							 ...
							 <div class="tab-pane fades"  id="server_div">
										...
										<input type="hidden" name="supplierMatSe.id" value="${currSupplier.supplierMatSe.id}" />
										  <input type="hidden" name="supplierMatSe.supplierId" value="${currSupplier.id}" />
												...
												<li class="col-md-3 col-sm-6 col-xs-12 pl10"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 组织机构：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSe.orgName" required maxlength="20" value="${currSupplier.supplierMatSe.orgName}" <c:if test="${fn:contains(servePageField,'orgName')}">style="border: 1px solid red;" onmouseover="errorMsg('orgName','mat_serve_page')"</c:if>/>
													   <span class="add-on cur_point">i</span>
													   <span class="input-tip">不能为空</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 人员总数：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSe.totalPerson" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSe.totalPerson}" <c:if test="${fn:contains(servePageField,'totalPerson')}">style="border: 1px solid red;" onmouseover="errorMsg('totalPerson','mat_serve_page')"</c:if>/>
													     <span class="add-on cur_point">i</span>
													     <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 管理人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSe.totalMange" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSe.totalMange}" <c:if test="${fn:contains(servePageField,'totalMange')}">style="border: 1px solid red;" onmouseover="errorMsg('totalMange','mat_serve_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 技术人员数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSe.totalTech" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSe.totalTech}" <c:if test="${fn:contains(servePageField,'totalTech')}">style="border: 1px solid red;" onmouseover="errorMsg('totalTech','mat_serve_page')"</c:if>/>
													     <span class="add-on cur_point">i</span>
													     <span class="input-tip">不能为空，且为数字</span>
												...
												<li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><i class="red">*</i> 工人（职员）数量：</span>
													<div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
														<input type="text" name="supplierMatSe.totalWorker" required onkeyup="checknums(this)" value="${currSupplier.supplierMatSe.totalWorker}" <c:if test="${fn:contains(servePageField,'totalWorker')}">style="border: 1px solid red;" onmouseover="errorMsg('totalWorker','mat_serve_page')"</c:if>/>
													    <span class="add-on cur_point">i</span>
													    <span class="input-tip">不能为空，且为数字</span>
