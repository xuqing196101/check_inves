...
<tr>
  ...
  <td class="tc"><input type="text" maxlength="30" onblur="tempSave()" name="supplierMatPro.listSupplierCertPros[${certProNumber}].name" class="border0"/> </td>
  <td class="tc"><input type="text" maxlength="150" onblur="tempSave()" name="supplierMatPro.listSupplierCertPros[${certProNumber}].code" class="border0"/> </td>
  <td class="tc"><input type="text" maxlength="10" onblur="tempSave()" name="supplierMatPro.listSupplierCertPros[${certProNumber}].levelCert" class="border0"/> </td>
  <td class="tc"><input type="text" maxlength="30" onblur="tempSave()" name="supplierMatPro.listSupplierCertPros[${certProNumber}].licenceAuthorith" class="border0"/></td>
  <td class="tc">
