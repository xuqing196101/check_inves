    ...
    <script type="text/javascript">
      ...
      function extractVerify(projectId) {
        ...
        if(packageName){
          ...
          window.open("${pageContext.request.contextPath}/SupplierExtracts_new/Extraction.html?projectId=" + projectId + "&packageId=" + packageId + "&projectInto=relPro" + "&packageName=" + packageName);
        } else {
          layer.msg("请选择包!");
        }
