...
<div id="levelTypeContent" class="levelTypeContent"
     style="display:none; position: absolute;left:0px; top:0px; z-index:999;">
            ...
            <ul class="ul_list" style="background-color: #fbfbfb">
                <li class="col-md-3 col-sm-6 col-xs-12 pl15">
                    ...
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                        ...
                        <select name="city" class="col-md-6 col-sm-6 col-xs-6 p0" id="city"
                ...
                <li class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="input-append input_group col-sm-12 col-xs-12 p0">
                        <input class="input_group " readonly id="extCategoryName"
                ...
                <li class="col-md-3 col-sm-3 col-xs-3 dnone" id="serviceCount">
                    ...
                    <div class="input-append input_group col-sm-12 col-xs-12 p0">
                        <input class="title col-md-12" id="service" name="serviceCount" onchange="chane();"
                               maxlength="11" type="text">
                        <span class="add-on">i</span>
                        <div class="cue">${loginPwdError}</div>
                    </div>
                ...
                <li class="col-md-12 col-sm-12 col-xs-12 tc">
                    <div>
                        <button class="btn " onclick="cityt();" type="button">抽取</button>
                                        ...
                                        <c:choose>
                                            <c:when test="${listyes.operatingType==1}">
                                                <option selected="selected" disabled="disabled"
                                                        value='${listyes.id},${listyes.supplierConditionId},1'>能参加
                                                </option>
                                            </c:when>
                                            <c:when test="${listyes.operatingType==2}">
                                                ...
                                                <option
                                                        value='${listyes.id},${listyes.supplierConditionId},3'>不能参加
                                                </option>
                                                <option selected="selected" disabled="disabled"
                                                        value='${listyes.id},${listyes.supplierConditionId},2'>待定
                                                </option>
                                            </c:when>
