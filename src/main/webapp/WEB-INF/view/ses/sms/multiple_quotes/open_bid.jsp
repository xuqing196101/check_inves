        ...
        <form action="" id="myForm" method="post" class="mb0">
            ...
            <div class="p0${st.index} hide">
                    ...
                    <table class="table table-bordered left_table">
                        ...
                        <c:forEach items="${list.projectDetail}" var="detail" varStatus="ls">
                            ...
                            <tr>
                                ...
                                <td class="p0"><input class="m0" id="goodsName" title="${detail.goodsName}"
                                                      value="${detail.goodsName}" type="text" class="m0"/></td>
                                <td class="p0"><input class="m0" id="brand" value="${detail.brand}" type="text"/></td>
                                <td class="p0"><input type="text" id="stand" readonly="readonly" title="${detail.stand}"
                                                      value="${detail.stand}"/></td>
                                <td class="p0"><input id="item" class="m0" readonly="readonly" value="${detail.item}"
                                                      type="text"/></td>
                                <td class="p0"><input class="m0" id="purchaseCount" value="${detail.purchaseCount}"
                                                      type="text" readonly="readonly"/>
                                    <input name="openBidInfoList[${index}].projectsDetailId" type="hidden"
                                           value="${detail.id}"/></td>
                                <td class="p0"><input name="openBidInfoList[${index}].unitPrice" class="m0"
                                                      id="unitPrice" value="${detail.price}" type="text"/></td>
                                <td class="p0"><input class="m0" id="budget" value="" type="text" readonly="readonly"/>
                                </td>
                                <td class="p0"><input name="openBidInfoList[${index}].deliveryTheGoods" class="m0"
                                                      id="deliveryTheGoods" title="${detail.deliverDate}"
                                                      value="${detail.deliverDate}" type="text"/></td>
                                <td class="p0"><input name="openBidInfoList[${index}].remark" id="remark"
                                                      value="${detail.memo}" title="${detail.memo}" type="text"
                                                      class="m0"/></td>
                            </tr>
                            </tbody>
                            <%-- <tbody>
                ...
                <div class="col-md-12 clear tc mt10">
                    ...
                    <button class="btn btn-windows apply mb20" type="button" onclick="save()">确定</button>
