	...
	<div class="wrapper">
			...
			<div class="col-md-12 p20 border1 margin-top-20 mb40">
				...
				<div class="tab-content margin-bottom-20 margin-top-20 lh24">
					...
					<div class="mt40 tc">
						...
						<button id="register_input_id" class="btn btn-windows git"   type="button" onclick="supplierRegist('reg_box_id', 2, 'next')">开始注册</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="reg_box_id_3" class="container clear margin-top-30 yinc">
			<h2 class="padding-20 mt40">
				...
				<form id="form2" action="${pageContext.request.contextPath}/importSupplier/register.html" method="post">
