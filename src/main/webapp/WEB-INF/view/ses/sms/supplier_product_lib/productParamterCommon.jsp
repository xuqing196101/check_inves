	...
	<c:forEach items="${ smsProductInfo.smsProductArguments }" var="categoryParam" varStatus="vs">
        <c:if test="${'字符' eq categoryParam.parameterType }">
			<li class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0 ">
                <input value='${ categoryParam.parameterValue }' type="text" readonly="readonly">
        ...
        <c:if test="${'日期' eq categoryParam.parameterType }">
			<li class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0 ">
              	<input class="Wdate w200 mb0" readonly="readonly" value="<fmt:formatDate value="${ categoryParam.parameterValue }" pattern="yyyy-MM-dd"/>" type="text" id="d17" onfocus="WdatePicker({firstDayOfWeek:1})"/>
                <span class="add-on">i</span>
                <span class="input-tip">${ categoryParam.categoryParameter.paramName }</span>
                <div class="cue"></div>
              </div>
        ...
        <c:if test="${'附件' eq categoryParam.parameterType }">
            <li class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0 " >
              	<u:show showId="param_picture${ vs.index }" businessId="${ categoryParam.parameterValue }" sysKey="${ sysKey }" typeId="${typeId }" delete="false" />
                <span class="input-tip">${ categoryParam.categoryParameter.paramName }</span>
                <div class="cue"></div>
              </div>
            </li>
