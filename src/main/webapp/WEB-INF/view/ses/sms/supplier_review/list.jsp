  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="col-md-12 pl20 mt10">
        ...
        <button class="btn btn-windows check" type="button" onclick="jumppage('${pageContext.request.contextPath}/supplierAttachAudit/certOther.html?supplierId=56ceb633d54f427b951c95d8d36ccebd')">重新复核</button>
      </div>
