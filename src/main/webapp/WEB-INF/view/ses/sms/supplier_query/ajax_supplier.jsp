    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function info(supplierId) {
                parent.document.location.href = "${pageContext.request.contextPath}/supplierQuery/essential.html?judge=2&supplierId=" + supplierId;
            }
        </script>
    </head>
                ...
                <tbody>
                    <c:forEach items="${listSupplier.list }" var="list" varStatus="vs">
                        <tr>
                            ...
                            <td class="pl20">
                                <a href="javascript:info('${list.id}');">${list.supplierName }</a>
                            </td>
