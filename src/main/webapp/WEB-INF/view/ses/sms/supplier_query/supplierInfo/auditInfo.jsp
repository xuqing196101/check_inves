                ...
                <table class="table table-bordered table-condensed table-hover">
                    ...
                    <c:forEach items="${auditList }" var="audit" varStatus="vs">
                        ...
                        <tr>
                            ...
                            <td class="tc"
                                title="<fmt:formatDate value="${audit.createdAt}" pattern="yyyy-MM-dd HH:mm:ss"/>">
                ...
                <div class="ul_list">
                    <table class="table table-bordered table-condensed table-hover">
                        <li class="col-md-6 col-sm-6 col-xs-6">
                            <div>
                                <span class="fl">批准审核表：</span>
                                <u:show showId="pic_checkword" businessId="${ suppliers.id}1" sysKey="${ sysKey }" typeId="${typeId }" delete="false"/>
                            </div>
                        </li>
                    </table>
                </div>
