				...
				<div class="col-md-12 tab-v2 job-content">
					<div class="padding-top-10 tab_menu" id="tabs">
						<ul id="page_ul_id" class="nav nav-tabs bgdd">
							...
							<li id="li_id_3" class=""><a aria-expanded="false" href="#tab-3" data-toggle="tab" class="fujian f18">场所信息</a></li>
							<li id="li_id_3" class=""><a aria-expanded="false" href="#tab-4" data-toggle="tab" class="fujian f18">监管部门信息</a></li>
						</ul>
						<form action="${pageContext.request.contextPath}/purchaseManage/updatePurchaseDep.do" method="post" id="formID">
							...
							<div class="tab-content padding-top-20">
								...
								<div class="tab-pane fade active in height-450" id="tab-1">
									...
									<input class="hide" name="orgnization.id" type="hidden"
										value="${purchaseDep.orgId }"> <input class="hide"
										name="id" type="hidden" value="${purchaseDep.id }">
									<ul class="list-unstyled list-flow p0_20">
										...
										<li class="col-md-6  p0 "><span class="">省：</span>
											<div class="input-append">
												<select class="span2" name="provinceId" id="province"
										...
										<li class="col-md-6  p0 "><span class="">市：</span>
											<div class="input-append">
												<select class="span2" name="cityId" id="city"
									...
									<ul class="list-unstyled list-flow p0_20">
										...
										<li class="col-md-6  p0 "><span class="">采购资质范围：</span> <select
											class="span2" name="quaRange" type="text">
												<option value="">-请选择-</option>
								...
								<div class="tab-pane fade height-200" id="tab-3">
									...
									<div class="clear"></div>
									<input type="button" class="btn" id="dynamicAdd"
										onclick="addOffice();" value="添加场所"></input>
