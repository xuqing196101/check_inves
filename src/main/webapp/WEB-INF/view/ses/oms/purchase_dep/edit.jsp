    ...
    <div class="container mt20">
      <div class="tab-content">
        <div class="tab-v2">
          ...
          <sf:form action="${pageContext.request.contextPath}/purchaseManage/updatePurchaseDep.html" method="post" id="formID" modelAttribute="purchaseDep">
              ...
              <div class="tab-pane fade active in" id="tab-1">
                ...
                <ul class="ul_list">
                  <li class="col-md-3 col-sm-6 col-xs-12 pl15"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5"><span class="star_red">*</span>采购机构名称</span>
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                      <input class="input_group" name="name" type="text" required maxlength="100" onblur="verify(this);" value="${purchaseDep.name }"> <span class="add-on">i</span>
                ...
                <ul class="ul_list">
                  ...
                  <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">采购资质编号</span>
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                      <input class="input_group" name="quaCode" maxlength="50" type="text" value="${purchaseDep.quaCode}"> <span class="add-on">i</span>
                ...
                <ul class="ul_list">
                  ...
                  <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">委托代理人</span>
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                      <input class="input_group" name="agent" value="${purchaseDep.agent}" maxlength="40" type="text"> <span class="add-on">i</span>
                  ...
                  <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">联系电话</span>
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                      <input class="input_group" name="contactTelephone" maxlength="40" value="${purchaseDep.contactTelephone}" type="text">
                      <span class="add-on">i</span>
                  ...
                  <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">开户银行</span>
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                      <input class="input_group" name="bank" value="${purchaseDep.bank}" maxlength="40" type="text"> <span class="add-on">i</span>
              ...
              <div class="tab-pane fade height-200" id="tab-3">
               ...
               <ul class="ul_list">
                  ...
                  <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">评标室数量</span>
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                      <input class="input_group" name="bidRoomCount" maxlength="40" value="${purchaseDep.bidRoomCount}" onkeyup="this.value=this.value.replace(/\D/g,'')" type="text">
                      <span class="add-on">i</span>
