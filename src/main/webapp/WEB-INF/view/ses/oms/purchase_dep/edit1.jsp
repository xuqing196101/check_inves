...
<script type="text/javascript">
	...
	function addOffice(){
		...
		$("#tab-position").append("<tr id="+num+" align='center'>"
            					+"<td>"+num+"</td>"     
                                +"<td><select class='purchaseRoomTypeName' id=purchaseRoomTypeName"+num+" name='purchaseRoomTypeName'> <option value=''>请选择</option><option value='0'>办公室</option><option value='1'>会议室</option><option value='2'>招标室</option><option value='3'>评标室</option></select></td>"
                                //+"<td><input type='text' name='desc"+_len+"' id='name"+_len+"' value='"+_len+"' /></td>"
                                 +"<td><input id=purchaseRoomCode"+num+" name='purchaseRoomCode' style='width:100px;'/></td>"
	...
	function addOffice1(){
		$("#tab-position").append("<tr id="+num+" align='center'>"
                                ...
                                //+"<td><input type='text' name='desc"+_len+"' id='name"+_len+"' value='"+_len+"' /></td>"
                                 +"<td class='tc'  ><input name='' style='width:100px;' /></td>"
                                +"<td class='tc w100' style='width:100px;'><input name='' style='width:100px;'/></td>"
                                   +"<td class='tc w100' style='width:100px;'><input name=''/></td>"
                                    +"<td class='tc w100' style='width:100px;'><input name=''/></td>"
                                     +"<td class='tc w100' style='width:100px;'><input name=''/></td>"
                                    +"<td class='tc w100' style='width:100px;'><select name=''> <option value='-1'>请选择</option><option value='0'>是</option><option value='1'>否</option></select></td>"
                                    +"<td class='tc w100'><select name=''> <option value='-1'>请选择</option><option value='0'>是</option><option value='1'>否</option></select></td>"
                                +"<td><a href=\'#\' onclick=\'delPositionTr(this)\'>删除</a></td>"
                            +"</tr>"); 
                            num++;
	}
	function addOrg(){
		$("#tab-orgnization").append("<tr id="+num2+" align='center'>"
                                ...
                                +"<td><a href=\'#\' onclick=\'delOrgTr(this)\'>删除</a></td>"
                            +"</tr>"); 
                            num2++;
	}
							...
							<div class="tab-content padding-top-20">
								...
								<div class="tab-pane fade active in height-450" id="tab-1">
									<div class=" margin-bottom-0">
										...
										<ul class="list-unstyled list-flow p0_20">
											<li class="col-md-6 p0"><span class="">采购机构名称：</span>
												<div class="input-append">
													<input class="span2" name="orgnization.name" type="text"
											...
											<li class="col-md-6 p0"><span class="">采购机构简称：</span>
												<div class="input-append">
													<input class="span2" name="orgnization.shortName"
											...
											<li class="col-md-6  p0 "><span class="">采购机构单位级别：</span>
												<div class="input-append">
													<input class="span2" name="levelDep" type="text"
														value="${purchaseDep.levelDep }"> <span
														class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">行政隶属单位：</span>
												<div class="input-append">
													<input class="span2" name="subordinateOrgName"
											...
											<li class="col-md-6 p0"><span class="">采购机构地址：</span>
												<div class="input-append">
													<input class="span2" name="orgnization.address" type="text"
										...
										<ul class="list-unstyled list-flow p0_20">
											<li class="col-md-6 p0"><span class="">采购资质等级：</span> <select
												class="span2" name="quaLevel" type="text">
													<option value="">-请选择-</option>
											...
											<li class="col-md-6  p0 "><span class=""><i
												...
												<div class="input-append">
													<input class="span2" type="text" readonly="readonly"
													...
													<span class="add-on"> <img
														src="${pageContext.request.contextPath}/public/ZHQ/images/time_icon.png"
														class="mb10" /> </span>
												</div></li>
											<li class="col-md-6  p0 "><span class=""><i
										...
										<ul class="list-unstyled list-flow p0_20">
											<li class="col-md-6 p0"><span class="">单位主要领导姓名及电话：</span>
												<div class="input-append">
													<input class="span2" name="leaderTelephone" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">军官编制人数：</span>
												<div class="input-append">
													<input class="span2" name="officerCountnum" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">军官现有人数：</span>
												<div class="input-append">
													<input class="span2" name="officerNowCounts" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">士兵现有人数：</span>
												<div class="input-append">
													<input class="span2" name="soldierNowCounts" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6 p0"><span class="">士兵编制人数：</span>
												<div class="input-append">
													<input class="span2" name="soldierNum" type="text">
													<span class="add-on">i</span>
												</div></li>
											...
											<li class="col-md-6  p0 "><span class="">职工现有人数：</span>
												<div class="input-append">
													<input class="span2" name="staffNowCounts" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">具备采购资格人员数量：</span>
												<div class="input-append">
													<input class="span2" name="purchasersCount" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">初级采购师人数：</span>
												<div class="input-append">
													<input class="span2" name="juniorPurCount" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">高级采购师人数：</span>
												<div class="input-append">
													<input class="span2" name="seniorPurCount" type="text">
													<span class="add-on">i</span>
												</div></li>
											<div class="clear"></div>
										</ul>
										...
										<ul class="list-unstyled list-flow p0_20">
											...
											<li class="col-md-6  p0 "><span class="">委托代理人：</span>
												<div class="input-append">
													<input class="span2" name="agent" type="text"> <span
														class="add-on">i</span>
												</div></li>
											...
											<li class="col-md-6  p0 "><span class="">联系电话：</span>
												<div class="input-append">
													<input class="span2" name="contactTelephone" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">通讯地址：</span>
												<div class="input-append">
													<input class="span2" name="contactAddress" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">邮政编码：</span>
												<div class="input-append">
													<input class="span2" name="unitPostCode" type="text">
													<span class="add-on">i</span>
												</div></li>
											...
											<li class="col-md-6  p0 "><span class="">开户银行：</span>
												<div class="input-append">
													<input class="span2" name="bank" type="text"> <span
														class="add-on">i</span>
												</div></li>
										...
										<ul class="list-unstyled list-flow p0_20">
											<li class="col-md-6 p0"><span class="">办公场地总面积：</span>
												<div class="input-append">
													<input class="span2" name="officeArea" type="text"
														value="${purchaseDep.officeArea}"> <span
														class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">办公司数量：</span>
												<div class="input-append">
													<input class="span2" name="officeCount" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">会议室数量：</span>
												<div class="input-append">
													<input class="span2" name="mettingRoomCount" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">招标室数量：</span>
												<div class="input-append">
													<input class="span2" name="inviteRoomCount" type="text">
													<span class="add-on">i</span>
												</div></li>
											<li class="col-md-6  p0 "><span class="">评标室数量：</span>
												<div class="input-append">
													<input class="span2" name="bidRoomCount" type="text">
													<span class="add-on">i</span>
												</div></li>
										</ul>
										<div class="mt40 mb50">
