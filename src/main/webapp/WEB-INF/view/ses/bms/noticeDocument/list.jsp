  ...
  <body>
   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="${ pageContext.request.contextPath }/" target="_blank"> 首页</a></li><li><a href="javascript:void(0)">支撑系统</a></li><li><a href="javascript:void(0)">后台管理</a></li><li class="active"><a href="javascript:jumppage('${ pageContext.request.contextPath }/noticeDocument/getAll.html')">须知文档管理</a></li>
		   </ul>
		<div class="clear"></div>
	  </div>
   </div>
...
<!-- 表格开始-->
  ...
  <div class="content table_box">
		...
		<tr>
		  ...
		  <th class="info" width="15%">须知文档类型</th>
		  <th class="info" width="35%">须知文档名称</th>
		  <th class="info" width="20%">创建日期</th>
		...
		<c:forEach items="${list.list}" var="noticeDocument" varStatus="vs">
			<tr>
				...
				<td class="tl" onclick="view('${noticeDocument.id}')">
					<c:forEach items="${noticeType}" var="type">
				...
				<td class="tl" onclick="view('${noticeDocument.id}')">${noticeDocument.name}</td>
