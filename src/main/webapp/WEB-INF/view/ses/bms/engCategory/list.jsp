...
<script type="text/javascript">
	...
	var datas;
	 ...
	 var setting={
		   async:{
					autoParam:["id"],
					enable:true,
					url:"${pageContext.request.contextPath}/engCategory/createtree.do",
	...
	function save(){
    	...
    	$.ajax({
    		...
    		type:"post",
    		data:$("#fm").serialize(),
    		url:"${pageContext.request.contextPath}/engCategory/save.do",
    		success:function(data){
  ...
  function  determine(operaType){
	  ...
	  $.ajax({
		  ...
		  async: false,
	  	  url:"${pageContext.request.contextPath}/engCategory/calledStatus.do",
  ...
  function delNode(){
	  $.ajax({
	  		type:"post",
	  		url:"${pageContext.request.contextPath}/engCategory/deleted.do?id=" + treeid,
	  		success:function(data){
	  			if (data == "success") {
	  				refreshParentNode();
	  				layer.msg('删除成功');
