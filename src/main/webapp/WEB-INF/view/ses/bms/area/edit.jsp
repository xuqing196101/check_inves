               ...
               <ul class="list-unstyled mt10 p0_20">
                 <li class="col-md-6 p0">
                   ...
                   <div class="input-append">
                    <input id="citySel" class="span2" name="pname" type="text" readonly value="${area1.name}"  onclick="showMenu();" />
                 ...
                 <li class="col-md-6 p0">
                   ...
                   <div class="input-append">
                    <input class="span2" name="name" value="${area.name }"   maxlength="30" type="text">
                    <span class="add-on">i</span>
                   </div>
                 </li>
                 <li class="col-md-6 p0">
