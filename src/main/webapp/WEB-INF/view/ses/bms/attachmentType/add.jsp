...
<script type="text/javascript">
	function back(){
		window.location.href = '<%=basePath%>attachmentType/list.html?page=1';
	}
</script>
<body>
   <!--面包屑导航开始-->
   <div class="margin-top-10 breadcrumbs ">
	   <div class="container">
		   <ul class="breadcrumb margin-left-0">
		   	<li><a href="#"> 首页</a></li><li><a href="#">支撑系统</a></li><li><a href="#">后台管理</a></li><li class="active"><a href="#">附件类型管理</a></li><li class="active"><a href="#">增加附件类型</a></li>
		   </ul>
		   <div class="clear"></div>
	   </div>
   </div>
   <div class="container bggrey border1 mt20">
   	   <sf:form action="${pageContext.request.contextPath}/attachmentType/save.html" method="post" modelAttribute="at">
		   <div>
