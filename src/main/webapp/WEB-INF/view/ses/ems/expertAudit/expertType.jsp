						...
						<li>
							<div>
								<c:forEach items="${spList}" var="sp">
									...
									<c:if test="${fn:contains(conditionStr,sp.id)}"><img src='${pageContext.request.contextPath}/public/backend/images/sc.png'></c:if> 
								</c:forEach>
								<c:forEach items="${jjList}" var="jj">
									...
									<c:if test="${fn:contains(conditionStr,jj.id)}"> <img src='${pageContext.request.contextPath}/public/backend/images/sc.png'></c:if>
								</c:forEach>
