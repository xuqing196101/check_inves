			...
			if(queType==1||queType==2){
				...
				for(var i=0;i<array.length;i++){
					if($(errorOption[i]).val()==""||$(errorOption[i]).val()==null){
						ohtml = ohtml+"<div class='clear mt10 col-md-12 col-sm-12 col-xs-12 p0'><div class='fl mt5'><div class='red star_red'>*</div>"+array[i]+"</div><textarea name='option' class='ml5 col-md-10 col-sm-10 col-xs-10 p0'></textarea></div>";
					}else{
						ohtml = ohtml+"<div class='clear mt10 col-md-12 col-sm-12 col-xs-12 p0'><div class='fl mt5'><div class='red star_red'>*</div>"+array[i]+"</div><textarea name='option' class='ml5 col-md-10 col-sm-10 col-xs-10 p0'>"+$(errorOption[i]).val()+"</textarea></div>";
					}
					if(queType==1){
			     ...
			     <li class="col-md-12 col-sm-12 col-xs-12 pl15">
		  		...
		  		<li class="col-md-12 col-sm-12 col-xs-12 pl15">
					...
					<div class="col-md-12 col-sm-12 col-xs-12 p0">
			  			<textarea class="col-md-10 col-sm-10 col-xs-10 h80 p0" name="topic" id="queTopic">${purchaserQue.topic }</textarea>
