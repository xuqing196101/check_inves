	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				for(var i = 0; i < array.length; i++) {
					if($(errorOption[i]).val() == "" || $(errorOption[i]).val() == null) {
						...
						ohtml = ohtml + "<div class='clear mt10 col-md-12 col-sm-12 col-xs-12 p0'><div class='fl mt5'><div class='red fl'>*</div>" + array[i] + "</div><textarea name='option' class='ml5 col-md-10 col-sm-10 col-xs-10 pl5'>" + $(errorOption[i]).val() + "</textarea></div>";
					}
					if(queType == 1) {
			...
			function changeOpt() {
				...
				var ahtml = "";
				for(var i = 0; i < array.length; i++) {
					ohtml = ohtml + "<div class='clear mt10 col-md-12 col-sm-12 col-xs-12'><div class='fl mt5'><div class='star_red fl'>*</div>" + array[i] + "</div><textarea name='option' class='pl5 ml5 col-md-10 col-sm-10 col-xs-10'></textarea></div>";
					if(queType == 1) {
						ahtml = ahtml + "<input type='radio' name='answer' value='" + array[i] + "' class='mt0'/>" + array[i] + "&nbsp";
					} else if(queType == 2) {
						ahtml = ahtml + "<input type='checkbox' name='answer' value='" + array[i] + "' class='mt0'/>" + array[i] + "&nbsp";
				...
				<div class="ul_list">
					<ul class="list-unstyled col-md-6 col-sm-6 col-xs-12">
						...
						<li class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 p0">
								<textarea class="col-md-10 col-sm-10 col-xs-10 h80 pl5" name="topic" id="queTopic">${lawQue.topic }</textarea>
					...
					<ul class="list-unstyled col-md-6 col-sm-6 col-xs-12">
						...
						<li class="col-md-12 col-sm-12 col-xs-12 mt25">
							<span class="fl"><div class="red fl ml5">*</div>答案：</span>
