	...
	<script type="text/javascript">
			...
			laypage({
			    ...
			    jump: function(e, first){ //触发分页后的回调
			        if(!first){ //一定要加此判断，否则初始时会无限刷新
			            ...
			            location.href = "<%=basePath%>expertExam/searchLawExpPool.do?topic="+topic+"&questionTypeId="+questionTypeId+"&page="+e.curr;
			        }
			    }
			});
		})	
		...
		function query(){
			...
			if((topic==""||topic==null)&&(questionTypeId==""||questionTypeId==null)){
				window.location.href = "<%=basePath%>expertExam/searchLawExpPool.do";
			}else{
				window.location.href = "<%=basePath%>expertExam/searchLawExpPool.do?topic="+topic+"&questionTypeId="+questionTypeId;
			}
		}	
	</script>
  </head>
