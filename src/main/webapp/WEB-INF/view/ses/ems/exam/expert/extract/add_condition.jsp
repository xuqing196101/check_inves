  ...
  <head>
    ...
    <script type="text/javascript">
      ...
      function condition() {
        ...
        if(sum != 1) {
          html += "<tr>" +
            "<input class='hide' name='extCategoryId' id='extCategoryId'  type='hidden' value='" + $('#supplierTypeIds').val() + "'>" +
            "<input class='hide' name='extCategoryName' id='extCategoryName'  type='hidden' value='" + $('#supplierType').val().replace(",", "^") + "'>" +
            "<td class='tc w30'><input type='checkbox' value=''" +
            "name='chkItem' onclick='check()'></td>" +
            "<td class='tc'>";
          html += "<select name='expertsTypeId' onchange='expTypeChange(this);'  id='estype'>" +
          ...
          html += "<td class='tc'><input class='hide'  readonly='readonly' onclick='showSupplierTypeC(this);'  id='extCategoryNameC'  title='" + $("#supplierType").val() + "' type='text' value='" + $("#supplierType").val() + "'></td>" +
...
//     	  alert("a");
    	  ...
    	  $(inps).parent().parent().parent().parent().find("#estype option[value='1']").removeAttr("selected");
    	  $(inps).parent().parent().parent().parent().find("#estype option[value='2']").attr("selected","selected");
      }else{
//     	  alert("b");

        $(inps).parent().parent().parent().find("#estype option[value='2']").removeAttr("selected");
    	  $(inps).parent().parent().parent().find("#estype option[value='1']").attr("selected","selected");
      }
      
      
      
      $(inps).val(v);
      $(inps).parent().parent().parent().find("#extCategoryId").val(rid);
      $(inps).parent().parent().parent().find("#extCategoryName").val(v.replace(",","^"));
      
//     alert($(inps).parent().parent().parent().html());
//       $(inps).parent().parent().parent().parent().find("#extCategoryId").val(ids);
            ...
            <ul class="ul_list">
              <li class="col-md-4 col-sm-6 col-xs-12  pl15">
                ...
                <div class="input-append input_group col-sm-12 col-xs-12 p0">
                  <select class=" w150 fl" id="area" onchange="areas();">
                  </select>
                  <select name="extractionSites" class="w100 fl" id="city"></select>
              ...
              <li class="col-md-4 col-sm-6 col-xs-12 ">
                ...
                <div class="input-append input_group col-sm-12 col-xs-12 p0">
                  <input class="w118 fl" maxlength="2" value="${ExpExtCondition.ageMin}" id="ageMinC" name="ageMin" type="text"><span class="f14 fl ">至</span><input class="w118 fl" value="${ExpExtCondition.ageMax}" maxlength="2" id="ageMaxC" name="ageMax" type="text">
              ...
              <div class="w300">
                <button class="btn btn-windows add" id="save" onclick="condition();" type="button">添加</button>
                <button class="btn btn-windows delete" id="backups" onclick="del();" type="button">删除</button>
                <button class="btn btn-windows add" id="save" onclick="cityt();" type="button">保存条件</button>
              </div>
              ...
              <table class="table table-bordered table-condensed mt5">
                ...
                <tbody id="tbody">
                  <c:forEach items="${ExpExtCondition.conTypes}" var="conTypes">
                    <tr>
                      <input class="hide" type="hidden" name="typeId" value="${conTypes.id}">
                      <input class="hide" type="hidden" name="extCategoryId" id="extCategoryId" value="${conTypes.categoryId }">
                      <input class="hide" type="hidden" name="extCategoryName" id="extCategoryName" value="${conTypes.categoryName }">
                      <td class='tc w30'><input type="checkbox" value="${conTypes.categoryId},${conTypes.expertsTypeId},${conTypes.expertsCount},${conTypes.expertsQualification}" name="chkItem" onclick="check()"></td>
                      <td class="tc">
                        <select name='expertsTypeId' onchange="expTypeChange(this);" id='estype'>
