		   ...
		   <ul class="list-unstyled list-flow ">
		     <li class="col-md-12 p0">
			   ...
			   <div class="col-md-12 pl200 fn mt5 pwr9">
		        <textarea class="text_area col-md-12 " name="queTopic" id="queTopic">${comQue.topic }</textarea>
		       </div>
			 </li> 
		   </ul>
	  	</div>
		   ...
		   <ul class="list-unstyled list-flow p0_20 ">
		     <li class="col-md-12 p0">
			   ...
			   <div class="col-md-12 pl200 fn mt5 pwr9">
		        ...
		        <%--<textarea class="text_area col-md-12 " name="queOption" id="queOption">${comQue.queOption }</textarea>
		       --%></div>
			 </li> 
		   </ul>
	  	</div>
