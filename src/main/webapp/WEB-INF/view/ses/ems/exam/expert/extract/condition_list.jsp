		...
		<div class="col-md-12 col-sm-12 col-xs-12 container_box">
			<form id="form">
				...
				<ul class="ul_list">
					...
					<li class="col-md-3 col-sm-4 col-xs-12">
						...
						<div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
							<input class="span5" id="" name="" value="" type="text">
							<span class="add-on">i</span>
					...
					<li class="col-md-3 col-sm-4 col-xs-12">
						...
						<div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
							<input class="col-md-12 col-sm-12 col-xs-6 p0" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});" pattern='yyyy-MM-dd HH:mm:ss' type="text">
							<div class="cue" id=""></div>
						</div>
					</li>
					<li class="col-md-3 col-sm-4 col-xs-12">
						...
						<div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
							...
							<select class="col-md-6 col-sm-6 col-xs-6 p0" id= "city">
			...
			<ul class="ul_list">
				...
				<div class="col-md-12 clear tc mt10">
					<button class="btn" type="button" onclick="">人工抽取</button>
