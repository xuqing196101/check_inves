        ...
        <form id="form">
            ...
            <div>
                ...
                <div align="right" class=" pl20 mb10 hide isCurment_div">
                    ...
                    <!--           </select> -->
                    <button class="btn mb10"
                            onclick="add(2);" type="button">抽取
                    </button>
                    <button class="btn dnone"
                            onclick="record();" type="button">引用其他包
                    </button>
                </div>
                <div class="ul_list">
                    <div class="clear">
                        ...
                        <c:forEach items="${listResultExpert }" var="list" varStatus="vs">
                            ...
                            <div>
                                <h2 onclick="ycDiv(this,'${index}')" class="count_flow shrink hand" id="package">包名:<span class="f14 blue">${listResultExpert[index].name }</span><c:if test="${list.projectStatus=='YZZ'}"><span class="star_red">[该包已终止]</span></c:if><c:if test="${list.projectStatus=='ZJZXTP'}"><span class="star_red">[该包已转竟谈]</span></c:if></h2>
                            </div>
