...
<body>
    ...
    <div class="container">
      <ul class="breadcrumb margin-left-0">
        ...
        <li><a href="javascript:void(0);"
          onclick="jumppage('${pageContext.request.contextPath}/expertBlacklist/blacklist.html')">专家黑名单</a></li>
  ...
  <div class="container container_box">
    <form action="${pageContext.request.contextPath}/expertBlacklist/updateBlacklist.html"
      method="post" id="form1">
      <input type="hidden" name="id" value="${expert.id}"> <input type="hidden" name="operationType" value="1">
      <h2 class="count_flow">
        <i>1</i>修改信息
      </h2>
      <ul class="ul_list">
        ...
        <li class="col-md-3 col-sm-6 col-xs-12 ">
          ...
          <div class="input-append input_group col-sm-12 col-xs-12 p0">
            <input class="input_group" readonly="readonly"
              name="dateOfPunishment" required="required" type="text"
              value="<fmt:formatDate value="${expert.dateOfPunishment}" pattern='yyyy-MM-dd'/>"
              onclick='WdatePicker()'>
        ...
        <li class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 p0">
            <textarea class="col-md-12 col-sm-12 col-xs-12"
              style="height: 130px" title="这是必填字段，字数不超过200个字" maxlength="200" name="reason">${expert.reason }</textarea>
            <div class="cue">
              <sf:errors path="reason" />
            </div>
          </div>
          <span class=" red">${err_reason}</span></li>
      </ul>
      <h2 class="count_flow">
        <i>2</i>附件上传
      </h2>
      <ul class="ul_list">
        <li class="col-md-3 col-sm-6 col-xs-12 pl15" onclick = "clearErrorMsg()">
          ...
          <u:upload id="id_up" multiple="true" businessId="${expert.id}"
      ...
      <div class="margin-bottom-0  categories">
        <div class="col-md-12 add_regist tc">
          ...
          <a class="btn btn-windows back"
            onclick="location.href='${pageContext.request.contextPath}/expertBlacklist/blacklist.html'">返回</a>
        </div>
      </div>
    </form>
  </div>
  <form target="_blank" id="download_form_id"
    action="${pageContext.request.contextPath}/expertBlacklist/download.html"
    method="post">
