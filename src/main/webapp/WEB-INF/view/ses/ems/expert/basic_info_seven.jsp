...
<form id="formExpert" action="${pageContext.request.contextPath}/expert/add.html" method="post">
    ...
    <div id="reg_box_id_3" class="container clear margin-top-30 job-content">
        <h2 class="padding-20 mt40">
            <span id="sp1" class="new_step current fl" onclick="pre1()"><i class="">1</i><div class="line"></div> <span
            ...
            <span id="sp7" class="new_step current fl"><i class="">2</i><div class="line"></div> <span
                    class="step_desc_02">专家类别</span> </span>
            ...
            <span id="sp4" class="new_step fl"><i class="">5</i><div class="line"></div> <span
                    class="step_desc_01">文件下载</span> </span>
            ...
            <ul style="display:none" id="zyzg">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span
                    ...
                    <div
                            ...
                            <c:if test="${fn:contains(errorField,'执业资格证书')}">style="border: 1px solid #ef0000;"
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span
                    ...
                    <div
                            class="input-append input_group col-sm-12 col-xs-12 col-md-12 p0">
                        <input
                                <c:if test="${fn:contains(errorField,'执业资格时间')}">style="border: 1px solid #ef0000;"
                                onmouseover="errorMsg('执业资格时间')"</c:if>
