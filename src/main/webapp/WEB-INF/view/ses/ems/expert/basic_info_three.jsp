...
<form id="formExpert" action="${pageContext.request.contextPath}/expert/add.html" method="post">
    ...
    <div id="reg_box_id_5" class="container clear margin-top-30 yinc">
        <h2 class="padding-20 mt40">
            <span id="jg1" class="new_step current fl" onclick='operation(1)'><i class="">1</i><div class="line"></div> <span
            ...
            <span id="sp7" class="new_step current fl" onclick='operation(7)'><i class="">2</i><div class="line"></div> <span
                    class="step_desc_02">专家类别</span> </span>
            <span id="ty6" class="new_step current fl" onclick='operation(6)'><i class="">3</i><div class="line"></div> <span
                    class="step_desc_01">产品类别</span> </span>
            <span id="jg3" class="new_step current fl"><i class="">4</i><div class="line"></div> <span
                    class="step_desc_02">采购机构</span> </span>
            <span id="jg4" class="new_step fl"><i class="">5</i><div class="line"></div> <span
