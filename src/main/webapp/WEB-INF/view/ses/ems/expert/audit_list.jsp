	...
	function selectAll(){
       ...
       for(i=0;i<ids.length;i++) {
    		...
    		if(count>1){
    			...
    			window.location.href="${pageContext.request.contextPath}/expert/toShenHe.do?id="+id;
      
       	}
    }
   </script>
   <form action="${pageContext.request.contextPath}/expert/findAllExpertShenHe.html"  method="post" id="form1" class="registerform"> 
