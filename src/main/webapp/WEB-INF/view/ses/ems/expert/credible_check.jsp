					...
					<table class="table table-bordered table-condensed table-hover table-striped">
						...
						<c:forEach items="${result.list }" var="e" varStatus="vs">
							<tr style="cursor: pointer; ">
								...
								<td class="tc">
									<fmt:formatDate type='date' value='${e.createAt }' dateStyle="default" pattern="yyyy-MM-dd" />
								</td>
								<td class="tc">
									<fmt:formatDate type='date' value='${e.updateAt }' dateStyle="default" pattern="yyyy-MM-dd" />
								</td>
