    ...
    <div id="reg_box_id_3" class="container clear margin-top-30 job-content">
        <h2 class="padding-20 mt40">
          ...
          <%--  <span id="sp2" class="new_step fl"><i class="">2</i><div class="line"></div> <span class="step_desc_01">经历经验</span> </span>--%>
            <span id="sp7" class="new_step fl"><i class="">2</i><div class="line"></div> <span class="step_desc_02">专家类型</span> </span>
            <span id="ty6" class="new_step fl"><i class="">3</i><div class="line"></div> <span class="step_desc_01">产品类别</span> </span>
            <span id="sp3" class="new_step fl"><i class="">4</i><div class="line"></div> <span class="step_desc_02">采购机构</span> </span>
            <span id="sp4" class="new_step fl"><i class="">5</i><div class="line"></div> <span class="step_desc_01">承诺书和申请表</span> </span>
            <span id="sp5" class="new_step fl"><i class="">6</i> <span class="step_desc_02">提交审核</span> </span>
            <div class="clear"></div>
        </h2>
        <div class="container container_box">
            ...
            <ul class="ul_list">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i class="red">*</i>专家技术职称</span>
                    <div class="input-append input_group col-sm-12 col-xs-12 col-md-12 p0">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12">
                    <span class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i class="red">*</i> 技术职称</span>
               ...
               <%-- <li class="col-md-3 col-sm-6 col-xs-12">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-xs-12 col-sm-12 padding-left-5"> 参加工作时间</span>
                    <div class="input-append input_group col-sm-12 col-xs-12 col-md-12 p0">
                        <input <c:if test="${fn:contains(errorField,'参加工作时间')}">style="border: 1px solid #ef0000;" onmouseover="errorMsg('参加工作时间')"</c:if> readonly="readonly"
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i class="red"></i>相关机关事业部门推荐信</span>
                    <div class="input-append input_group col-sm-12 col-xs-12 col-md-12 p0">
            ...
            <ul class="ul_list">
                ...
                <div class="padding-top-10 clear">
                   <%-- <h2 class="count_flow"><i>3</i><font color=red></font>获奖证书(限国家科技进步三等或军队科技进步二等以上奖项)</h2>--%>
                    ...
                    <div class="input-append h30 input_group col-sm-12 col-xs-12 col-md-12 p0" <c:if test="${fn:contains(errorField,'学位证书')}">style="border: 1px solid #ef0000;" onmouseover="errorMsg('学位证书')"</c:if>>
                        <u:upload singleFileSize="${properties['file.picture.upload.singleFileSize']}" exts="${properties['file.picture.type']}" id="expert18" groups="expert1,expert2,expert3,expert4,expert5,expert6,expert7,expert8" multiple="true" businessId="${sysId}" sysKey="${expertKey}" typeId="${typeMap.EXPERT_DEGREE_TYPEID}" auto="true" />
                        <u:show showId="show18" groups="show1,show2,show3,show4,show5,show6,show7,show8" businessId="${sysId}" sysKey="${expertKey}" typeId="${typeMap.EXPERT_DEGREE_TYPEID}" />
                    </div>
                </div>
            </ul>
