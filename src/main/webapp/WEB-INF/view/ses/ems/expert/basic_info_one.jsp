...
<form id="formExpert" action="${pageContext.request.contextPath}/expert/add.html" method="post">
    ...
    <div id="reg_box_id_3" class="container clear margin-top-30 job-content">
        <h2 class="padding-20 mt40">
            <span id="sp1" class="new_step current fl"><i class="">1</i><div class="line"></div> <span
                    class="step_desc_02">基本信息</span> </span>
            <%--  <span id="sp2" class="new_step fl"><i class="">2</i><div class="line"></div> <span class="step_desc_01">经历经验</span> </span>--%>
            <span id="sp7" class="new_step fl"><i class="">2</i><div class="line"></div> <span
                    class="step_desc_02">专家类型</span> </span>
            <span id="ty6" class="new_step fl"><i class="">3</i><div class="line"></div> <span
                    class="step_desc_01">产品类别</span> </span>
            <span id="sp3" class="new_step fl"><i class="">4</i><div class="line"></div> <span
                    class="step_desc_02">采购机构</span> </span>
        ...
        <div class="container container_box">
            ...
            <ul class="ul_list">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="select_common col-md-12 col-xs-12 col-sm-12 p0">
                        <select name="gender" id="gender"
                                <c:if test="${fn:contains(errorField,'性别')}">style="border: 1px solid #ef0000;"
                                onmouseover="errorMsg('性别')"</c:if>>
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i
                    ...
                    <div class="select_common col-md-12 col-xs-12 col-sm-12 p0">
                        <select name="politicsStatus" id="politicsStatus"
                                <c:if test="${fn:contains(errorField,'政治面貌')}">style="border: 1px solid #ef0000;"
                                onmouseover="errorMsg('政治面貌')"</c:if>>
                            <option selected="selected" value="">-请选择-</option>
                ...
                <c:if test="${expert.expertsFrom eq 'ARMY'}">
                    <li class="col-md-3 col-sm-6 col-xs-12"><span
                            class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i class="red">*</i> 军队人员身份证件类型</span>
                        <div class="select_common col-md-12 col-xs-12 col-sm-12 p0">
                            <select name="idType" id="idType"
                                    <c:if test="${fn:contains(errorField,'军队人员身份证件类型')}">style="border: 1px solid #ef0000;"
                                    onmouseover="errorMsg('军队人员身份证件类型')"</c:if>>
                                <option selected="selected" value="">-请选择-</option>
                    ...
                    <li class="col-md-3 col-sm-6 col-xs-12"><span
                            class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i class="red">*</i> 证件号码</span>
                        <div class="input-append input_group col-sm-12 col-xs-12 col-md-12 p0">
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span
                    ...
                    <div class="input-append input_group col-sm-12 col-xs-12 col-md-12 p0">
                        <input maxlength="10" value="${expert.atDuty}" name="atDuty" id="appendedInput" type="text"
                               <c:if test="${fn:contains(errorField,'现任职务')}">style="border: 1px solid #ef0000;"
                               onmouseover="errorMsg('现任职务')"</c:if>/>
                        <span class="add-on">i</span>
                ...
                <li class="col-md-3 col-sm-6 col-xs-12"><span class="col-md-12 col-xs-12 col-sm-12 padding-left-5"><i
                    ...
                    <div class="select_common col-md-12 col-xs-12 col-sm-12 p0">
                        <select name="hightEducation" id="hightEducation"
                                <c:if test="${fn:contains(errorField,'最高学历')}">style="border: 1px solid #ef0000;"
                                onmouseover="errorMsg('最高学历')"</c:if>>
                            <option selected="selected" value="">-请选择-</option>
