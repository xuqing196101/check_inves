			  ...
			  <input name = "id" type = "text" value="${complaint.id }" style="display: none;">
				<ul class="ul_list">
					<li class="col-md-3 col-sm-6 col-xs-12  pl15" >
						...
						<div class="col-md-12 mb20 col-sm-12 col-xs-12 p0">
							<div class="col-md-5 col-xs-5 col-xs-6 p0">
								<input type="radio" disabled="disabled" <c:if test="${0==complaint.type}">checked="checked"</c:if> name="type" id="PerSonTsype" value="0" onchange="hid()" class="mr5"/>单位
						    </div>
						    <div class="col-md-5 col-xs-5 col-xs-6 ">
								<input type="radio" disabled="disabled" <c:if test="${1==complaint.type}">checked="checked"</c:if> name="type" id="PerSonTsype" value="1" onchange="show()" class="mr5"/>个人
						    </div>
						</div> 
				  </li>
				  <li class="col-md-3 col-sm-6 col-xs-12 pl15"   >
				  ...
				  <li class="col-md-3 col-sm-6 col-xs-12 pl15" >
				  	...
				  	<div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                             <input class="" name="complaintObject" type="text" value="${complaint.complaintObject }" disabled="disabled">
                     </div>
				  </li>
				  <li class="col-md-12 col-sm-12 col-xs-12">
	                <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">投诉事项</span>
	                 <div class="col-md-12 col-sm-12 col-xs-12 p0">
                      <textarea class="col-md-12 col-sm-12 col-xs-12" style="height:130px" title="不超过1000个字" name="complaintMatter" disabled="disabled">${complaint.complaintMatter }</textarea>
                     </div>
	              </li>
	              <c:if test="${complaint.status == 1 || complaint.status == 3}">
	              <li class="col-md-12 col-sm-12 col-xs-12">
	                <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">立项结果</span>
	                 <div class="col-md-12 col-sm-12 col-xs-12 p0">
                      <textarea class="col-md-12 col-sm-12 col-xs-12" style="height:130px" title="不超过1000个字" name="complaintMatter" disabled="disabled">${complaint.resion }</textarea>
                     </div>
	              </li>
	              </c:if>
				<c:if test="${complaint.status == 2 }">
					<li class="col-md-12 col-sm-12 col-xs-12">
	                <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">驳回理由</span>
	                 <div class="col-md-12 col-sm-12 col-xs-12 p0">
                      <textarea class="col-md-12 col-sm-12 col-xs-12" style="height:130px" title="不超过1000个字" name="complaintMatter" disabled="disabled">${complaint.resion }</textarea>
                     </div>
	              </li>
