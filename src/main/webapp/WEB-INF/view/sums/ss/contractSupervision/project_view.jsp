  ...
  <head>
    ...
    <script type="text/javascript">
      function view(id,type){
        window.location.href = "${pageContext.request.contextPath}/contractSupervision/viewPack.html?id="+id+"&contractId=${contractId}";
      }
    </script>
  </head>
          ...
          <tbody id="tbody_id">
            <c:forEach items="${listProject}" var="obj" varStatus="vs">
              <tr class="pointer">
                ...
                <td class="tc " onclick="view('${obj.id}','0')">${obj.purchaseDepName}</td>
