...
<html>
  ...
  function demandDateil(id){
     location.href = "${pageContext.request.contextPath}/projectSupervision/demandDateil.html?id="+id+"&projectId=${projectId}";
    }
    </script>
  </head>
          ...
          <c:forEach items="${list}" var="obj" varStatus="vs">
            <tr style="cursor: pointer;">
              ...
              <td class="tc">
                ...
                <a href="javascript:void(0)" onclick="demandDateil('${obj.id}');">进入</a>
              </td>
            </tr>
          </c:forEach>
        </table>
