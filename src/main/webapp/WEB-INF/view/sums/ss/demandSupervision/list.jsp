...
//					        return page ? page[1] : 1;
	...
	<body>
		...
		<div class="container">
			...
			<form action="${pageContext.request.contextPath }/supervision/demandSupervisionList.html" method="post">
				
				<div class="search_detail">
				<ul class="demand_list">
					<li>
			    	<label class="fl">需求名称：</label><span><input type="text" id="name" name="name" class=""/></span>
			    </li>
		  		<li>
			    	<label class="fl">产品名称：</label><span><input type="text" id="GOODS_NAME" name="GOODS_NAME" class=""/></span>
			    </li>
		  		<li>
			    	<label class="fl">产品目录：</label><span><input type="text" id="contractCode" name="contractCode" class=""/></span>
			    </li>
			    <li>
			    	<label class="fl">预算金额：</label><span><input type="text" id="contractCode" name="contractCode" class=""/></span>
			    </li>
			    <li style="width: 255px">
			     ...
			     <li>
			    	<label class="fl">填报时间：</label><span><input type="text" id="contractCode" name="contractCode" class="w80"/><span class="fl">到</span><input type="text" id="contractCode" name="contractCode" class="w80"/></span>
			    </li>
			    <li class="fr w220 tc" >
			...
			<div class="content table_box">
				<table class="table table-bordered table-condensed table-hover">
					...
					<tbody>
						<c:forEach items="${info.list}" var="items" varStatus="status" >
							<tr class="tc">
								<td>info.list</td>
								<td>${info.list.planName}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
