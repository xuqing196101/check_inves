...
<html>
  ...
  <body>
    <div class="margin-top-10 breadcrumbs ">
      <div class="container">
        <ul class="breadcrumb margin-left-0">
          ...
          <li>
            <a href="javascript:jumppage('${pageContext.request.contextPath}/supervision/demandSupervisionByAll.html');">采购需求监督</a>
          </li>
        </ul>
        <div class="clear"></div>
      </div>
    ...
    <div class="container">
      ...
      <form id="add_form" action="${pageContext.request.contextPath }/supervision/demandSupervisionByAll.html" class="mb0" method="post" >
        ...
        <div class="row">
          ...
          <div class="col-xs-2 col-sm-4 col-md-4 col-lg-3 mb10">
            <div class="row">
              <div class="col-xs-4 f14 h32 lh32 tr text-nowrapEl">采购需求编号：</div>
              <div class="col-xs-8 f0 lh0">
                <input type="text" name="planNo" id="planNo" value="${purchaseRequired.planNo}" class="w100p h32 f14 mb0 mb0">
              </div>
            </div>
          </div>
          ...
          <div class="col-xs-2 col-sm-4 col-md-4 col-lg-3 mb10">
            <div class="row">
              ...
              <div class="col-xs-8 f0 lh0">
                <input id="createdAt" class="Wdate w100p h32 f14 mb0 mb0" value='<fmt:formatDate value="${purchaseRequired.createdAt }"/>' name="createdAt" type="text" onclick='WdatePicker()'>
              </div>
            </div>
          </div>
