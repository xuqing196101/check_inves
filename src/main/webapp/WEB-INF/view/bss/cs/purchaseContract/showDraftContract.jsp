	...
	<div class="margin-top-10 breadcrumbs ">
		<div class="container">
			<ul class="breadcrumb margin-left-0">
				...
				<li class="active"><a href="javascript:void(0);">合同草案查看</a></li>
			</ul>
			<div class="clear"></div>
		</div>
	</div>
				...
				<div class="padding-top-10">
					<ul class="nav nav-tabs bgwhite">
						<li class="active"><a aria-expanded="true" href="#tab-1"
							data-toggle="tab" class="f18">合同草案详情</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<td width="37%"><fmt:formatDate
											value="${draftCon.draftGitAt}" pattern="yyyy-MM-dd HH:mm:ss" /></td>

								</tr>
								<tr>
									<td class="bggrey" width="13%">草案报批时间：</td>
									<td width="37%"><fmt:formatDate
											value="${draftCon.draftReviewedAt}"
						...
						<div class="col-md-12 col-xs-12 col-sm-12 p0">
							...
							<div class="fl mt10">
								<u:show showId="post_attach_show" delete="false"
									...
									businessId="${draftCon.id}" sysKey="${attachsysKey}"
									typeId="${attachtypeId}" />
							</div>
						</div>
						<div class="col-md-12 col-xs-12 col-sm-12 p0">
