 ...
 <div class="row magazine-page">
   <div class="col-md-12 tab-v2">
          ...
          <div class="tab-content padding-top-20">
			 ...
			 <ul class="list-unstyled ul_list">
				 ...
				 <li class="col-md-3 col-sm-6 col-xs-12">
				   <span class="col-md-12 padding-left-5 col-sm-12 col-xs-12"><div class="red star_red">*</div>甲方联系电话：</span>
			        <div class="input-append input_group col-sm-12 col-xs-12 p0">
			         <input class=" supplier_name" id="purchaseContactTelephone" name="purchaseContactTelephone" maxlength="50" value="${purCon.purchaseContactTelephone}" type="text">
				...
				<%--  <li class="col-md-3 col-sm-6 col-xs-12 pl15">
				 ...
				 <li class="col-md-3 col-sm-6 col-xs-12">
				   <span class="col-md-12 padding-left-5 col-sm-12 col-xs-12"><div class="red star_red">*</div>乙方联系电话：</span>
			        <div class="input-append input_group col-sm-12 col-xs-12 p0">
			         <input class=" supplier_name" id="supplierContactTelephone" name="supplierContactTelephone" maxlength="50" value="${purCon.supplierContactTelephone}" type="text">
            ...
            <div class="tab-pane fade " id="tab-2">
              ...
              <div class="col-md-12 col-xs-12 col-sm-12 p0">
				...
				<td class="tc"><input type="text" name="proList[${(vs.index)}].goodsName" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.goodsName}" class="tl"/></td>
				<td class="tc"><input type="text" name="proList[${(vs.index)}].brand" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.brand}" class="tl"/></td>
				<td class="tc"><input type="text" name="proList[${(vs.index)}].stand" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.stand}" class="w60 tl"/></td>
				<td class="tc"><input type="text" name="proList[${(vs.index)}].item" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.item}" class="w50 tc"/></td>
				...
				<td class="tc"><input type="text" name="proList[${(vs.index)}].price" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.price}" class="w50 tr"/></td>
				<td class="tc"><input type="text" name="proList[${(vs.index)}].amount" <c:if test="${reque.transportFees!=1}">readonly="readonly"</c:if> value="${reque.amount}" class=" w50 tr"/></td>
				<td class="tc"><input type="text" name="proList[${(vs.index)}].deliverDate" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if>  value="${reque.deliverDate}" class="w100 tl"/></td>
				<td class="tc"><input type="text" name="proList[${(vs.index)}].memo" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.memo}" class=" tl"/></td>
						</tr>
			   		</c:forEach>
			   		</tbody>
				</table>
		...
		<div  class="col-md-12 tc mt20">
			<input type="button" class="btn btn-windows save mb20" onclick="update()" value="保存">
