	...
	<script type="text/javascript">
		...
		function save() {
			...
			$.ajax({
				...
				dataType: "json",
				data: {
					"draftGitAt": draftGitAt,
					"draftReviewedAt": draftReviewedAt
				},
				success: function(data) {
					if(data == 1) {
						$("#status").val("1");
			...
			<div class="row magazine-page">
				<div class="col-md-12 tab-v2">
					<div class="padding-top-10">
						<ul class="flow_step">
							<li class="active">
								<a aria-expanded="true" href="#tab-1" data-toggle="tab" class="">基本信息</a><i></i></li>
							<li class="">
								<a aria-expanded="false" href="#tab-2" data-toggle="tab" class="">标的信息</a><i></i></li>
							<li class="">
								<a aria-expanded="false" href="#tab-3" data-toggle="tab" class="">合同文本</a>
							</li>
						</ul>
				 ...
				 --%>
									...
									<ul class="list-unstyled ul_list">
										...
										<li class="col-md-3 col-sm-6 col-xs-12">
											<div class="red star_red">*</div>甲方通讯地址：</span>
											<div class="input-append input_group col-sm-12 col-xs-12 p0">
												...
												<tbody id="trs">
													<c:forEach items="${requList}" var="reque" varStatus="vs">
														<tr <c:if test="${reque.transportFees==1}"> id="transportFees_tr"</c:if>>
															...
															<td class="tr pr20"><input type="text" name="proList[${(vs.index)}].amount" <c:if test="${reque.transportFees!=1}">readonly="readonly"</c:if> value="${reque.amount}" class="w50 tr" /></td>
															<td class="tc"><input type="text" name="proList[${(vs.index)}].deliverDate" <c:if test="${purCon.manualType!=1}">readonly="readonly"</c:if> value="${reque.deliverDate}" class="tl w100" /></td>
