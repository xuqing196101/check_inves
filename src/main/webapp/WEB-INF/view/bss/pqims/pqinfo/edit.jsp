          ...
          <ul class="ul_list">
            ...
            <li class="col-md-3 col-sm-6 col-xs-12">
              ...
              <div class="input-append col-md-12 col-sm-12 col-xs-12 input_group p0">
                <input class="span5 contractCode" id="contractCode" name="contract.code" readonly="readonly" type="text" value="${pqinfo.contract.code }">
        ...
        <div class="padding-top-10 clear">
          ...
          <ul class="ul_list">
            ...
            <li class="col-md-12 col-sm-12 col-xs-12 mt10" id="picNone">
              ...
              <div class="">
                <u:upload id="artice_up" businessId="${pqinfo.id}" sysKey="${pqinfoKey}" typeId="${attachtypeId }" buttonName="上传质检报告图片" auto="true" exts="png,jpeg,jpg,bmp,git" />
                <u:show showId="artice_show" businessId="${pqinfo.id}" sysKey="${pqinfoKey}" typeId="${attachtypeId }" />
              </div>
            </li>
          </ul>
