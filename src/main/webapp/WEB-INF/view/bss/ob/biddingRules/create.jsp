   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
        <ul class="breadcrumb margin-left-0">
			...
			<li class="active"><a href="javascript:jumppage('http://localhost:8088/obrule/ruleList.html')">竞价规则管理</a></li>
			<li class="active"><a href="javascript:void(0)">创建竞价规则</a></li>
		</ul>
        <div class="clear"></div>
      </div>
   </div>
  ...
  <div class="container">
	  ...
	  <div class="bggrey p20">
  		<form id="ruleForm" action="" method="post">
		    <h2 class="list_title mt0">添加竞价规则</h2>
		   <ul class="ul_list">
