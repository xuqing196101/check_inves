...
<html>
	...
	/* 发布定型产品 */
	function publish(){
		window.location.href="${pageContext.request.contextPath}/finalize_DesignProduct/publish.html";
	}
	
	/* 修改定型产品 */
	function edit(){
		window.location.href="${pageContext.request.contextPath}/finalize_DesignProduct/edit.html";
...
<!-- 表格开始 -->
	<div class="col-md-12 pl20 mt10">
		<button class="btn btn-windows apply" type="button" onclick="publish()">发布定型产品</button>
	...
	<div class="content table_box">
		...
		<tr>
		  ...
		  <td class="tc"><a href = "${pageContext.request.contextPath}/finalize_DesignProduct/qualifiedSupplierlist.html">3</a></td>
		</tr>
		<tr>
		  <td class="tc w30"><input onclick="check()" type="checkbox" name="chkItem" value="" /></td>
