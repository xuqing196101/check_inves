   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		  <ul class="breadcrumb margin-left-0">
			  ...
			  <li>
				  <a href="javascript:jumppage('${pageContext.request.contextPath}/offer/userAppraisalList.html')">审价人员审价</a>
			  </li>
		  </ul>
		<div class="clear"></div>
	  </div>
    ...
    <div class="container">
	   <div class="headline-v2">
		...
		<form action="${pageContext.request.contextPath}/offer/userAppraisalList.html" method="post" enctype="multipart/form-data" class="mb0">
    <div class="m_row_5">
    <div class="row">
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
        <div class="row">
          ...
          <div class="col-xs-8 f0 lh0">
            <input type="text" name="name" id="name" value="${ap.name }" class="w100p h32 f14 mb0">
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
        <div class="row">
          ...
          <div class="col-xs-8 f0 lh0">
            <input type="text" name="code" id="code" value="${ap.code }" class="w100p h32 f14 mb0">
          </div>
        </div>
      </div>
      ...
      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
        <div class="row">
          ...
          <div class="col-xs-8 f0 lh0">
            <input type="text" name="supplierName" id="supplierName" value="${ap.supplier.supplierName }" class="w100p h32 f14 mb0">
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-xs-12 f0">
            <button class="btn mb0 h32" type="submit">查询</button>
  					<button type="reset" class="btn mb0 mr0 h32" onclick="window.location.href = '${pageContext.request.contextPath}/offer/userAppraisalList.html'">重置</button>
          </div>
        </div>
      </div>
    </div>
             ...
             <table class="table table-bordered table-condensed table-hover table-striped">
						...
						<c:forEach items="${list.list}" var="contract" varStatus="vs">
				  			...
				  			<tr>
				  				...
				  				<td class="pointer">${contract.name }</td>
				  				<td class="pointer">${contract.code }</td>
				  				<td class="tr">${contract.money }</td>
				  				<td class="pointer">${contract.supplier.supplierName }</td>
