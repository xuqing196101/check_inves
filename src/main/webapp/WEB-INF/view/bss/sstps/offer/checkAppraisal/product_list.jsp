  ...
  <body>
   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="javascript:void(0)"> 首页</a></li><li><a href="javascript:void(0)">审价人员复审</a></li><li><a href="javascript:void(0)">产品复审</a></li></ul>
		<div class="clear"></div>
	  </div>
   </div>
						...
						<thead>
				  		...
				  		<c:forEach items="${list.list}" var="product" varStatus="vs">
				  			...
				  			<tr class="pointer">
				  				...
				  				<td class="tc" name="auditOffer">已审价</td>
				  			</tr>
				  			</c:if>
						</c:forEach>
					</table>
