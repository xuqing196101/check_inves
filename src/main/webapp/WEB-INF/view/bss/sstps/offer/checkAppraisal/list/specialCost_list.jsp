...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath%>outsourcingCon/checkGetAll.do?productId="+proId;
}
  ...
  <div class="container">
	...
	<div class="container margin-top-5">
	 	<form action="<%=basePath %>specialCost/checkUpdate.html?productId=${proId }" method="post" enctype="multipart/form-data">
