...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath%>outproductCon/userGetAll.do?productId="+proId;
}
  ...
  <div class="container">
	...
	<div class="container margin-top-5">
	 	<form action="<%=basePath %>outsourcingCon/userUpdate.html?productId=${proId }" method="post" enctype="multipart/form-data">
