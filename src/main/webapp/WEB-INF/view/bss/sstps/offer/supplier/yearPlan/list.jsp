...
function nextStep(){
	...
	window.location.href="${pageContext.request.contextPath}/productQuota/select.do?proId="+proId+"&total="+total;
}
  ...
  <body>
   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="javascript:void(0)"> 首页</a></li><li><a href="javascript:void(0)">供应商报价</a></li><li><a href="javascript:void(0)">年度计划任务总工时明细</a></li></ul>
		<div class="clear"></div>
	  </div>
   </div>
