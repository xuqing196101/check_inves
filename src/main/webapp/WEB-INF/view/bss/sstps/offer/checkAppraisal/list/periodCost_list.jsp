...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath%>manufacturingCost/checkGetAll.do?productId="+proId;
}
  ...
  <div class="container">
	...
	<div class="container margin-top-5">
		<form action="<%=basePath %>periodCost/checkUpdate.html?productId=${proId }" method="post" enctype="multipart/form-data">
