...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath%>yearPlan/checkGetAll.do?productId="+proId;
}
  ...
  <div class="container">
	...
	<div class="container margin-top-5">
	 	<form action="<%=basePath %>productQuota/checkUpdate.html?productId=${proId }" method="post" enctype="multipart/form-data">
