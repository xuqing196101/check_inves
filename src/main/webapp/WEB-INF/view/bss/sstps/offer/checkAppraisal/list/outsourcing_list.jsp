   ...
   <div class="margin-top-10 breadcrumbs ">
	   <div class="container">
		   <ul class="breadcrumb margin-left-0">
			   ...
			   <li><a href="javascript:void(0)">外协加工件消耗定额明细</a></li>
		   </ul>
		   <div class="clear"></div>
	   </div>
   </div>
	 	...
	 	<div class="col-md-12 col-sm-12 col-xs-12">
			<table id="table1" class="table table-bordered table-condensed">
				...
				<c:forEach items="${list}" var="out" varStatus="vs">
					<tr>
						<td class="tc">${vs.index+1 }<input type="hidden" name="listOutSou[${vs.index+1 }].id" value="${out.id }" /></td>
						<td class="tl">${out.outsourcingName }</td>
