...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath %>accessoriesCon/checkGetAll.html?productId="+proId;
}
  ...
  <div class="container">
	...
	<form action="<%=basePath %>outproductCon/checkUpdate.html?productId=${proId }" method="post" enctype="multipart/form-data">
	 	<div class="container padding-left-25 padding-right-25">
			<table class="table table-bordered table-condensed">
				...
				<c:forEach items="${list}" var="out" varStatus="vs">
					<tr>
						<td>${vs.index+1 }<input type="hidden" name="outproductCons['${vs.index }'].id" value="${out.id }" /></td>
