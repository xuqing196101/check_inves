...
<html>
  ...
  <body>
    ...
    <div class="margin-top-10 breadcrumbs ">
      <div class="container">
        <ul class="breadcrumb margin-left-0">
          ...
          <li>
            <a href="javascript:void(0)">添加原、辅材料工艺定额消耗明细</a>
          </li>
        </ul>
        <div class="clear"></div>
      </div>
    ...
    <div class="container container_box">
      <form action="${pageContext.request.contextPath }/accessoriesCon/update.html" method="post">
        ...
        <div>
          ...
          <ul class="ul_list mb20">
            <li class="col-md-3 col-sm-6 col-xs-12 pl15">
              <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">材料性质：</span>
              <div class="select_common input_group col-md-12 col-sm-12 col-xs-12 p0">
                <select class="" id="productNature" name="productNature">
        ...
        <div class="padding-top-10 clear">
          ...
          <ul class="ul_list mb20">
            ...
            <li class="col-md-3 col-sm-6 col-xs-12 col-md-3">
              <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">金额：</span>
              <div class="select_common input_group col-sm-12 col-xs-12 p0">
        ...
        <div class="padding-top-10 clear">
          ...
          <ul class="ul_list mb20">
            <li class="col-md-4 col-xs-12 col-sm-6 pl15">
            ...
            <li class="col-md-12 col-xs-12 col-sm-12">
              <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5 fl">备注：</span>
              <div class="col-md-12 p0 mt5 col-xs-12 col-sm-12">
