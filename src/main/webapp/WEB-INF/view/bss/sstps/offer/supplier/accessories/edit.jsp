            ...
            <li class="col-md-3 col-sm-6 col-xs-12 pl15">
              ...
              <div class="select_common input_group col-sm-12 col-xs-12 p0">
                <select class="col-md-12" id="productNature" name="productNature">
                  ...
                  <option value="0"    <c:if test="${acc.productNature==0}"> selected="selected"</c:if> >主要材料</option>
                  <option value="1"  <c:if test="${acc.productNature==1}"> selected="selected"</c:if>>辅助材料</option>
                </select>
