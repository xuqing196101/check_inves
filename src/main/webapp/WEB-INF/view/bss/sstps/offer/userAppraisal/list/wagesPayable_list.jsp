...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath%>burningPower/userGetAll.do?productId="+proId;
}
function nextStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath%>manufacturingCost/userGetAll.html?productId="+proId;
}
</script>
