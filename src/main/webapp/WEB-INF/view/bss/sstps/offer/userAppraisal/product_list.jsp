...
<div class="margin-top-10 breadcrumbs ">
    <div class="container">
        <ul class="breadcrumb margin-left-0">
            ...
            <li>
                <a href="javascript:void(0)">产品审价</a>
            </li>
        </ul>
        <div class="clear"></div>
    </div>
...
<div class="container">
    ...
    <div class="search_detail">
        <form id="form1" action="${pageContext.request.contextPath}/offer/selectProductUser.html?contractId=${id}"
    ...
    <div class="content table_box">
        <table class="table table-bordered table-condensed table-hover table-striped">
            ...
            <c:forEach items="${list.list}" var="product" varStatus="vs">
                ...
                <tr>
                    <td class="tc w50" id="tds"><input onclick="check()" type="checkbox" name="chkItem"
                                                       value="${product.id }"/><input type="hidden"
                                                                                      value="${product.offer}"/></td>
