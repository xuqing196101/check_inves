...
function onStep(){
  ...
  <body>
   ...
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="javascript:void(0)">首页</a></li><li><a href="javascript:void(0)">单一来源审价</a></li><li><a href="javascript:void(0)">审价人员复审</a></li><li><a href="javascript:void(0)">原、辅材料工艺定额消耗明细复审<a></li></ul>
		<div class="clear"></div>
	  </div>
   </div>
  ...
  <div class="container">
	...
	<div class="container margin-top-5">
		<form action="${pageContext.request.contextPath}/accessoriesCon/userUpdateCheck.html?productId=${proId }" method="post" enctype="multipart/form-data">
				...
				<tbody>
				  <c:forEach items="${list}" var="acc" varStatus="vs">
					<tr>
						...
						<td class="tc"><input type="text" value='${acc.checkMoney }' name="accessoriesCons['${vs.index }'].checkMoney"></td>
