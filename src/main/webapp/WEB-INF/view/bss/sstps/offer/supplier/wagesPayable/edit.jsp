        ...
        <div>
          ...
          <ul class="ul_list mb20">
            <li class="col-md-3 col-sm-6 col-xs-12 pl15">
              <span class="col-sm-12 col-xs-12 col-md-12 padding-left-5"><div class="star_red">*</div>部门：</span>
            ...
            <li class="col-md-3 col-sm-6 col-xs-12">
              <span class="col-sm-12 col-xs-12 col-md-12 padding-left-5"><div class="star_red">*</div>上级项目：</span>
              <div class="input-append col-sm-12 col-xs-12 col-md-12 input_group p0">
            ...
            <li class="col-md-3 col-sm-6 col-xs-12">
              <span class="col-sm-12 col-xs-12 col-md-12 padding-left-5"><div class="star_red">*</div>项目名称：</span>
              <div class="input-append col-sm-12 col-xs-12 col-md-12 input_group p0">
        ...
        <div class="padding-top-10 clear">
          ...
          <ul class="ul_list mb20">
            <li class="col-md-12 col-sm-12 col-xs-12">
              <span class="col-sm-12 col-xs-12 col-md-12 padding-left-5">备注：</span>
