...
function down(){
  ...
  <!--面包屑导航开始-->
   <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   ...
		   <li><a href="javascript:void(0)"> 首页</a></li><li><a href="javascript:void(0)">添加外购成品件消耗定额明细</a></li></ul>
		<div class="clear"></div>
	  </div>
   </div>
 ...
 <div class="container container_box"> 
   ...
   <li class="col-md-4 col-sm-6 col-xs-12 pl15">
	   <span class="col-md-12 col-sm-12 col-xs-12 padding-left-5">供货单位：</span>
	   <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
	 ...
	 <li class="col-md-12 col-sm-12 col-xs-12">
	   ...
	   <div class="col-md-12 col-sm-12 col-xs-12 p0">
        <textarea class="col-md-12 col-sm-12 col-xs-12 h80 " id="remark" name="remark" title="不超过200个字" placeholder="不超过200个字">${acc.remark } </textarea>
       </div>
	 </li>
   </ul>
   </div>
