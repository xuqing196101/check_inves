...
function down(){
 ...
 <!--面包屑导航开始-->
  ...
  <div class="container container_box"> 
    <form action="${pageContext.request.contextPath}/productQuota/save.html" method="post">
   ...
   <li class="col-md-3 col-sm-6 col-xs-12 pl15">
	 ...
	 <li class="col-md-12 col-sm-12 col-xs-12">
	   ...
	   <div class="col-md-12 col-sm-12 col-xs-12 p0">
        <textarea class="col-md-12 col-sm-12 col-xs-12 h80" id="remark" name="remark" title="不超过250个字" placeholder="不超过250个字">${pq.remark }</textarea>
       </div>
	 </li>
   </ul>
   </div>
