...
function onStep(){
	var proId = $("#proId").val();
	window.location.href="<%=basePath %>accessoriesCon/userGetAll.html?productId="+proId;
}
  ...
  <div class="container">
	...
	<form action="<%=basePath %>outproductCon/userUpdate.html?productId=${proId }" method="post" enctype="multipart/form-data">
