...
//	 			        return page ? page[1] : 1;
    ...
    function view(packageId,projectId){
    	window.open("${pageContext.request.contextPath}/adIntelligentScore/editPackageScore.html?packageId="+packageId+"&projectId="+projectId+"&flag="+1+"&flowDefineId=${flowDefineId}");   
    }
    ...
    function loadPackage(id){
    	...
    	$.ajax({  
            type: "POST",  
            url: "${pageContext.request.contextPath}/intelligentScore/saveLoadPackage.html",  
