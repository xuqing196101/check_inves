...
<head>
	  ...
	  laypage({
		    ...
		    jump: function(e, first){ //触发分页后的回调
		        if(!first){ //一定要加此判断，否则初始时会无限刷新
		        	$("#page").val(e.curr);
		            location.href = '${pageContext.request.contextPath}/adIntelligentScore/scoreModelList.html?page='+e.curr+'&packageId=${scoreModel.packageId}';
		        }
		    }
		});
  });
   ...
   /** 全选全不选 */
	...
	function prevStep(){
		...
		window.location.href = "${pageContext.request.contextPath}/adIntelligentScore/packageList.html?projectId=${projectId}" ;
	}
	//查看模型详细信息
	function showScoreModel(id){
		window.location.href = "${pageContext.request.contextPath}/adIntelligentScore/showScoreModel.html?id="+id ;
	}
</script>
</head>
...
<body onload="pageOnLoad();">
	...
	<div class="margin-top-10 breadcrumbs ">
		<div class="container">
			<ul class="breadcrumb margin-left-0">
				...
				<li><a href="#">立项管理</a></li>
				<li class="active"><a href="#">评分细则</a></li>
			</ul>
			<div class="clear"></div>
		</div>
	</div>
	...
	<div class="container">
		...
		<h2 class="search_detail">
			<form action="${pageContext.request.contextPath}/adIntelligentScore/scoreModelList.html" method="post" class="mb0" id="form1">
