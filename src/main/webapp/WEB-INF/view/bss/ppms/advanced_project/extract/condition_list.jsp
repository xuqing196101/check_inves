            ...
            laypage({
                ...
                jump: function (e, first) { //触发分页后的回调
                    if (!first) { //一定要加此判断，否则初始时会无限刷新projectNumber
                        location.href = '${pageContext.request.contextPath}/adExpExtract/Extraction.html?projectId=${projectId}&page=' + e.curr;
                    }
                }
        ...
        <form id="form">
            ...
            <ul class="ul_list">
                ...
                <li class="col-md-3 col-sm-4 col-xs-12 ">
                    ...
                    <div class="input-append input_group col-md-12 col-sm-12 col-xs-12 p0">
                        <input class="span5" id="purchaseType" name="purchaseType" value="${purchaseType}" type="text">
                        <span class="add-on">i</span>
                        <div class="cue" id="projectNumberError"></div>
                    </div>
                </li>
