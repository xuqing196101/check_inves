...
<html>
  ...
  <script type="text/javascript">
    ...
    function fitsrView(packageId, projectId, flowDefineId) {
      $("#tab-5").load("${pageContext.request.contextPath}/adPackageExpert/firstAuditView.html?packageId=" + packageId + "&projectId=" + projectId + "&flowDefineId=" + flowDefineId);
    }
      ...
      if(count > 0) {
        ...
        if(ids.length > 0) {
          layer.confirm('确定要汇总吗?', {
            ...
            $.ajax({
              type: "POST",
              url: "${pageContext.request.contextPath}/adPackageExpert/gather.html?projectId=" + projectId + "&packageIds=" + ids,
          ...
          <tr>
            ...
            <td class="tc">${rp.packageName}
              ...
              <c:forEach items="${packageList}" var="pa">
                <c:if test="${pa.id eq rp.packageId }">
            ...
            <td class="tc">
              <div class="col-md-12 padding-0">
                <div class="progress w55p fl margin-left-0">
                  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width:${rp.firstAuditProgress*100}%;">
                  </div>
                </div>
