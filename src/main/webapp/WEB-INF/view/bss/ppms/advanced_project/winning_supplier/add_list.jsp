            ...
            $.ajax({
              ...
              success: function(obj) {
                layer.alert(
                  ...
                  function() {
                    window.location.href = "${pageContext.request.contextPath}/adWinningSupplier/viewPackageSupplier.html?packageId=" + "${packageId}" + "&flowDefineId=${flowDefineId}&projectId=${projectId}&supplierIds=${supplierIds}";
                  }
                );
              },
              error: function(obj) {
