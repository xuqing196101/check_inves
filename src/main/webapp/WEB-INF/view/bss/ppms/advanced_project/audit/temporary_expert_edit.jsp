...
<html>
  ...
  <script type="text/javascript">
    ...
    function sumbits() {
      ...
      $("#tab-1").load("${pageContext.request.contextPath}/adExpExtract/editTemporaryExpert.do", encodeURI(encodeURI(formData)));
    }
  </script>
  ...
  <script type="text/javascript">
    ...
    function goBack() {
      ...
      var path = "${pageContext.request.contextPath}/adPackageExpert/assignedExpert.html?projectId=" + projectId + "&flowDefineId=" + flowDefineId;
      $("#tab-1").load(path);
    }
  </script>
  ...
  <script type="text/javascript">
    function showPackageType() {
      ...
      $.ajax({
        type: "GET",
        async: false,
        url: "${pageContext.request.contextPath}/adExpExtract/getpackage.do?projectId=${projectId}",
        dataType: "json",
        success: function(zNodes) {
  ...
  <body>
    ...
    <body>
      ...
      <!-- 修改订列表开始-->
      <div class="">
        <sf:form id="form" action="${pageContext.request.contextPath}/ExpExtract/editTemporaryExpert.do" method="post" modelAttribute="expert">
          <input type="hidden" value="${projectId}" name="projectId" />
          <input type="hidden" value="${expert.id}" name="id" id="id" />
          <input type="hidden" value="${packageId}" name="oldPackageId" id="oldPackageId" />
          <input type="hidden" value="${flowDefineId}" name="flowDefineId" />
          <div>
            <h2 class="list_title">修改临时专家</h2>
            <ul class="ul_list">
              ...
              <li class="col-md-3 col-sm-6 col-xs-12 ">
                ...
                <div class="input-append input_group col-sm-12 col-xs-12 p0">
                  ...
                  <span class="add-on">i</span>
                  <div class="cue" id="error_cardNumber">
                    <sf:errors path="idCardNumber" />${idCardNumberError}</div>
                </div>
              </li>
              <li class="col-md-3 col-sm-6 col-xs-12 ">
              ...
              <li class="col-md-3 col-sm-6 col-xs-12 ">
                ...
                <div class="input-append input_group col-sm-12 col-xs-12 p0">
                  <input class="title col-md-12" id="appendedInput" name="loginPwd" placeholder="******" value="${loginPwd}" maxlength="11" type="password">
                  <span class="add-on">i</span>
          ...
          <div class="">
            <div class="" align="center">
              <button class="btn btn-windows save" type="button" onclick="sumbits();">修改</button>
