...
<html class=" js cssanimations csstransitions" lang="en">
	...
	<body>
        <!-- 修改订列表开始-->
        <div>
            <form id="form1" action="${pageContext.request.contextPath}/adIntelligentScore/updateScoreMethod.html" method="post">
                <div class="container container_box">
                    ...
                    <ul class="list-unstyled m_boxS1">
                            ...
                            <li id="floatingRatio" class="col-md-3 col-sm-6 col-xs-12 clear mt25">
                            ...
                            <li id="valid" class="col-md-3 col-sm-6 col-xs-12 clear mt25">
                               <div class="col-md-12 col-xs- 12 col-sm-12 p0">
                            ...
                            <li id="business" class="col-md-3 col-sm-6 col-xs-12 dnone clear mt25">
