...
<script type="text/javascript">
	...
	function associate(){
		...
		if(s){
			$.ajax({   
	            type: "get",  
	            url: "${pageContext.request.contextPath}/adIntelligentScore/checkScore.do?standScore="+standScore+"&moxing2="+moxing2+"&id="+id+"&maxScore="+maxScore+"&projectId=${projectId}"+"&packageId=${packageId}",        
	            dataType:'json',
...
<body onload="pageOnLoad();">
	...
	<table id="model71" style="display: none;" class="w499">
		<tbody>
			...
			<tr>
				<td style="width: 300px;">最高分</td>
				<td><input name="maxScore" id="maxScore" onkeyup="gernerator();" value="${scoreModel.maxScore }" title="该项的满分值是多少"></td>
			</tr>
			<tr>
				<td style="width: 300px;">最低分</td>
				<td><input name="minScore" id="minScore" onkeyup="gernerator();" value="${scoreModel.minScore }" title="该项的最低分是多少"></td>
