...
<script type="text/javascript">
    ...
    function addScoreMethod(packageId,projectId) {
    	window.location.href = "${pageContext.request.contextPath}/adIntelligentScore/addScoreMethod.html?packageId="+packageId+"&projectId="+projectId;
    }
  ...
  <body>
	<div class="col-md-12 p0">
		<ul class="flow_step">
			<c:if test="${ope != 'view' }">
			<li><a
				href="${pageContext.request.contextPath}/adFirstAudit/toAdd.html?projectId=${projectId}">01、资格性和符合性审查</a>
				<i></i>
			</li>
			...
			<c:if test="${ope == 'view' }">
	   	 	<li >
			   <a  href="${pageContext.request.contextPath}/Adopen_bidding/firstAduitView.html?projectId=${projectId}" >01、资格性和符合性审查</a>
			   <i></i>
			 </li>
			<%--  <li>
		     ...
		     <li class="active">
			   <a  href="${pageContext.request.contextPath}/adIntelligentScore/packageListView.html?projectId=${projectId}">02、经济和技术评审细则</a>
			   <i></i>
			 </li>
			 <li>
			   <a  href="${pageContext.request.contextPath}/Adopen_bidding/bidFileView.html?id=${projectId}" >
			     03、招标文件
		         <%-- <c:if test="${project.dictionary.code eq 'GKZB' }">
			     03、招标文件
			     </c:if>
