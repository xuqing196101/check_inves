...
<script type="text/javascript">
	...
	function ycDiv(obj, index){
	 ...
	 function openMax(){
	 	window.open("${pageContext.request.contextPath}/Adopen_bidding/viewMingxi.html?projectId=${projectId}");
	 }; 
	 
	 function printCon(projectId, packageId){
	 	 window.location.href="${pageContext.request.contextPath}/Adopen_bidding/changmingxiWord.html?projectId="+projectId+"&packId="+packageId;
	 }
</script>
</head>
