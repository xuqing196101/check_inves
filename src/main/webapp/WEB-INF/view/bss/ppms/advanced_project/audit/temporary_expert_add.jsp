...
<html>
  ...
  <script type="text/javascript">
    ...
    function sumbits() {
      ...
      $("#tab-1").load("${pageContext.request.contextPath}/adExpExtract/AddtemporaryExpert.do", encodeURI(encodeURI(formData)));
    }
  </script>
  ...
  <body>
    ...
    <body>
      ...
      <!-- 修改订列表开始-->
      <div class="">
        <sf:form id="form" action="${pageContext.request.contextPath}/adExpExtract/AddtemporaryExpert.do" method="post" modelAttribute="expert">
