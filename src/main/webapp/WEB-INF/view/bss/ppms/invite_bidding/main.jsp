                  ...
                  <div class="col-md-12" style="min-height:400px;">
                      <div class="col-md-3 md-margin-bottom-40" id="show_tree_div">
                         <ul class="btn_list" id="menu">
                           ...
                           <li><a href="<%=basePath%>resultAnnouncement/resultAnnouncementAdd.html" target="open_bidding_main" class="son-menu">拟制中标公示</a></li>
                           <li><a href="<%=basePath%>open_bidding/" target="open_bidding_main" class="son-menu">发布中标公示</a></li>
                           <li><a href="<%=basePath%>winningSupplier/selectSupplier.html" target="open_bidding_main" class="son-menu">确定中标供应商</a></li>
                         </ul>
                      </div>
