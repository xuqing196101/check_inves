      ...
      laypage({
            ...
            jump: function(e, first){ //触发分页后的回调
                ...
                //  $("#page").val(e.curr);
                 ...
                 location.href = '${pageContext.request.contextPath}/project/edit.do?page='+e.curr;
                }  
            }
        });
  });
    ...
    function check(){
        ...
        if(id.length==1){
         ...
         // title: '您是要取消任务吗？',
          ...
          offset: ['100px', '250px'],
          shadeClose: true,
          content: '${pageContext.request.contextPath}/project/editDet.html?id='+id
        });
     ...
     function edit(){
        ...
        var projectNumber = $("#projectNumber").val();
          window.location.href= '${pageContext.request.contextPath}/project/update.html?id='+id+'&name='+name+'&projectNumber='+projectNumber;
