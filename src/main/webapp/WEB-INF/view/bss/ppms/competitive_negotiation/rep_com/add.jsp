    ...
    function inputTemplete(){
        ...
        function exportWord(){
        	...
        	if(content == null || content == ""){
	            ...
	            $("#form").attr("action",'${pageContext.request.contextPath}/pub_com/export.html');   
	            $("#form").submit();
        	}
        }
        //预览
        ...
        var articleId = $("#articleId").val();
        	if(articleId == null || articleId == ""){
             ...
             $("#form").attr("action",'${pageContext.request.contextPath}/pub_com/printView.html');   
             $("#form").submit();
        }
        //发布
        function publish(){
        	...
        	if(articleId == null || articleId == ""){
	            ...
	            layer.open({
	              ...
	              offset: '100px',
	              shadeClose: false,
	              content: '${pageContext.request.contextPath}/pub_com/publishEdit.html?id='+articleId,
	              success: function(layero, index){
	                iframeWin = window[layero.find('iframe')[0]['name']]; //得到iframe页的窗口对象，执行iframe页的方法：iframeWin.method();
	              }
	            });
        ...
        //    	$("#form").attr("action",'${pageContext.request.contextPath}/pub_com/saveBidNotice.do?name='+text);   
        //        $("#form").submit();               
        //     });
       // }
       ...
       function save(){
       		$.ajax({
			    type: 'post',
			    url: "${pageContext.request.contextPath}/pub_com/saveBidNotice.do",
			    dataType:'json',
			    data : $('#form').serialize(),
