...
<script type="text/javascript">
  ...
  <body>
	<div class="col-md-12 p0">
		<ul class="flow_step">
			<li><a
				href="${pageContext.request.contextPath}/firstAudit/toAdd_cn.html?projectId=${projectId}">01、符合性</a>
				<i></i>
			</li>

			<li><a
				href="${pageContext.request.contextPath}/firstAudit/toPackageFirstAudit_cn.html?projectId=${projectId}">02、符合性关联</a>
				<i></i>
			</li>
			<li class="active"><a
				href="${pageContext.request.contextPath}/intelligentScore/packageList_cn.html?projectId=${projectId}">03、评标细则</a>
				<i></i>
			</li>
			<li><a href="${pageContext.request.contextPath}/pub_tran/bidFile.html?id=${projectId}" >04、竞谈文件</a>
			</li>
		</ul>
	</div>
