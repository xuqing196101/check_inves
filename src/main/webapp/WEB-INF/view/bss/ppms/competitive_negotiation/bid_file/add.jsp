  ...
  <body>
	                     <div class="col-md-12 p0">
						   <ul class="flow_step">
						     ...
						     <li>
							   <a  href="${pageContext.request.contextPath}/intelligentScore/packageList_cn.html" data-toggle="tab">03、评标细则</a>
							   <i></i>
							 </li>
							 <li>
							   <a  href="${pageContext.request.contextPath}/pub_tran/bidFile.html?id=${projectId}" data-toggle="tab">04、竞谈文件</a>
							 </li>
						   </ul>
						 </div>
