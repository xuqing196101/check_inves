...
<html>
  ...
  <script type="text/javascript">
            ...
            if(data == "ERROR") {
              layer.confirm('成交数量将会出现小数，是否确定此占比分配？', {
                ...
                layer.confirm(
                  ...
                  function(index) {
                    layer.close(index);
                    window.location.href = "${pageContext.request.contextPath}/winningSupplier/packageSupplier.html?supplierIds=" + supplierIds + "&ids=" + id + "&flowDefineId=${flowDefineId}&passquote=${quote}&packageId=${packageId}&projectId=${projectId}&priceRatios=" + priceRatio;
                  }
                );
    ...
    function openDetail(packageId) {
      location.href = "${pageContext.request.contextPath}/winningSupplier/openPackage.do?packageId=${packageId}";
    }
  </script>
