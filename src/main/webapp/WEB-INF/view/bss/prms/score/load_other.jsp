...
//	 			        return page ? page[1] : 1;
    ...
    function view(packageId,projectId){
    	window.open("${pageContext.request.contextPath}/intelligentScore/editPackageScore.html?packageId="+packageId+"&projectId="+projectId+"&flag="+1+"&flowDefineId=${flowDefineId}");   
    }
