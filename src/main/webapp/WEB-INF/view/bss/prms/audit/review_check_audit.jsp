...
<script type="text/javascript">
  ...
  function submit1(){
	 ...
	 if(flag==1){
		 ...
		 window.location.href="${pageContext.request.contextPath}/expert/saveCheck.html?projectId="+projectId+"&packageId="+packageId;
	 }
  }
  ...
  function tempSave(){
	...
	var packageId = "${extension.packageId}";
  	$.ajax({
		...
		data: {"projectId": projectId, "packageId": packageId, 'auditType':1},
		dataType:'json',
    ...
    <div class="margin-top-10 breadcrumbs ">
      <div class="container">
		   <ul class="breadcrumb margin-left-0">
		   	<li><a href="javascript:void(0);">首页</a></li><li><a href="javascript:void(0);">项目评审</a></li><li><a href="javascript:void(0);">经济技术评审</a></li>
		   </ul>
		<div class="clear"></div>
	  </div>
    </div>
	<div class="container">
		<div class="container clear" id="package">
			...
			<form action="" method="post" >
			   <!--包id  -->
			   <input type="hidden" id="kind" value="${dd.id}">
			   <input type="hidden" id="packageId" name="packageId" value=""/>
		   	   ...
		   	   <div class="content table_box over_scroll">
				   <table class="table table-bordered table-condensed table-hover space_nowrap" id="table2">
				   		<thead>
				   		  <th class="info space_nowrap">评审项</th>
				   		  ...
				   		  <c:forEach items="${extension.supplierList}" var="supplier" varStatus="vs">
				   			...
				   			<tr><td class="info" colspan="${suppliers+1}"><b>${dd.name}</b></td></tr>
