...
<!-- 表格开始-->
   ...
   <div class="col-md-8">
   <a target="_blank" id="a" class="btn fl ml20 mt1"onclick="palte();" href="javascript:void(0)">模板管理</a>
   <button class="btn fl ml20 mt1" type="button" onclick="guanlian();">关联</button>
     <button class="btn fl ml20 mt1" type="button" onclick="cancel();">取消</button>
	</div>	
       </div>
    </div>
