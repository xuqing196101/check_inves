...
<div class="container clear margin-top-30" id="package" >
	<form action="<%=basePath %>auditTemplat/add.html" method="post" id="form1">
     <table class="table table-bordered table-condensed">
     <thead>
      <tr>
        <th>初审项模板名称:</th><td><input type="text" id="name" maxlength="30" name="name" ></td>
        <th>初审项模板类型:</th><td><input type="checkbox" name="kind"  value="商务" >商务&nbsp;<input type="checkbox" name="kind" id="kind" value="技术" >技术</td>
