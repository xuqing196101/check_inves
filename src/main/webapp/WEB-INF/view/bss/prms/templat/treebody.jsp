...
<script type="text/javascript">
	...
	function judgeRelationScore(index) {
		...
		if (index == 1) {
			if (relation == 1) {
				//最低分
				 	$("#relationScore").find("option[value='0']").attr("selected",false);
				 	$("#relationScore").find("option[value='1']").attr("selected",true);
			} else {
				//最高分
				 	$("#relationScore").find("option[value='1']").attr("selected",false);
				 	$("#relationScore").find("option[value='0']").attr("selected",true);
			}
		} else {
			if (relation == 1) {
				//最高分
