	 ...
	 //符合汇总
		...
		function isBack(obj){
		 ...
		 function showViewByExpertId(packageId,obj,i){
			 ...
			 if(count>0){
			     window.location.href='${pageContext.request.contextPath}/packageExpert/showViewByExpertId.html?expertId='+expertId+'&packageId='+packageId+'&projectId=${project.id}';
			 } else {
		 ...
		 function showViewBySupplierId(packageId,obj,i){
			 ...
			 if(count>0){
			     window.location.href='${pageContext.request.contextPath}/packageExpert/showViewBySupplierId.html?supplierId='+supplierId+'&packageId='+packageId+'&projectId=${project.id}&expertIds='+expertIds;
			 } else {
				 layer.alert("请先选择一项！",{offset: [y-150, x+200], shade:0.01});
			 }
		 }
   	 ...
   	 <!--循环供应商  -->
	      ...
	      <thead>
	        <tr>
		      ...
		      <th class="info"> <input type="button" class="btn" onclick="showViewBySupplierId('${packageId}',this,'${vs.index }')" value="查看明细"></th>
	        </tr>
	      </thead>
           ...
           <div align="center"><input type="button" class="btn btn-windows back" value="返回" onclick="javascript:window.location.href='${pageContext.request.contextPath}/packageExpert/toScoreAudit.html?projectId=${projectId}&flowDefineId=${flowDefineId}'"></div>
</body>
</html>
