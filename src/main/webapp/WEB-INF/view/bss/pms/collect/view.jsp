		...
		<form id="acc_form" action="${pageContext.request.contextPath}/accept/update.html" method="post">
					...
					<c:forEach items="${list }" var="obj" varStatus="vs">
						<tr>
							...
							<select class="type w100"  onchange="purchaseType(this)" required="required" name="list[${vs.index }].purchaseType" id="select">
			              ...
			              <%--   </c:if> --%>
							...
							<td class="tc p0">
							<%-- <c:if test="${obj.purchaseCount!=null }">  --%>
							<select  class="org w100" required="required"  name="list[${vs.index }].organization" onchange="org(this)">
