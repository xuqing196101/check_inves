...
<!-- 后台管理内容开始-->
<div >
	<iframe  frameborder="0" name="home" id="iframepage" scrolling="no" marginheight="0"  width="100%" onLoad="iFrameHeight()" src="<%=basePath%>supplierAgents/getAllSupplierAgents.do"></iframe>
</div>
