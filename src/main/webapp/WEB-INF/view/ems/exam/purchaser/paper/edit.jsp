...
<html>
  ...
  <body>
    ...
    <div>
    	试卷名称:<input type="text" name="paperName" value="${examPaper.name }"/>
    	试卷编号:<input type="text" name="paperNo" value="${examPaper.code }"/>
    </div>
    <div>
    ...
    <div>
    	总分值:<input type="text" name="totalPoint" id="totalPoint" value="${examPaper.score }"/>分
    </div>
    <div>
    	考试开始时间:<input type="text" name="startTime" id="startTime"/>
    </div>
    <div>
    	考试用时:<input type="text" name="useTime" id="useTime" value="${examPaper.testTime }"/>
    </div>
    <div>
