     ...
     <div class="content padding-left-25 padding-right-25 padding-top-5">
		...
		<c:forEach items="${list.list}" var="templet" varStatus="vs">
			<tr>
				...
				<td class="tc opinter" onclick="view('${templet.id}')"><fmt:formatDate value='${templet.createdAt}' pattern="yyyy年MM月dd日   HH:mm:ss " /></td>
			
				<td class="tc opinter" onclick="view('${templet.id}')"><fmt:formatDate value='${templet.updatedAt}' pattern="yyyy年MM月dd日   HH:mm:ss " /></td>
			</tr>
		</c:forEach>
        </table>
     </div>
