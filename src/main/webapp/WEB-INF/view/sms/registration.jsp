			...
			<div class="col-md-12 p20 border1 margin-top-20 mb40">
				...
				<div class="tab-content margin-bottom-20 margin-top-20 lh24">
					...
					<div class="mt40 tc">
						...
						<input id="register_input_id" type="button" class="btn padding-left-20 padding-right-20 btn_back" onclick="location='${pageContext.request.contextPath}/supplierInfo/register_page.do'" value="开始注册">
					</div>
				</div>
			</div>
		</div>
