				...
				<div class="row">
					<div class="login_main mt20">
						<div class="login_item">
							<label class="col-md-3 p0"><i class="red mr5">*</i>用 户 名：</label> <input type="text" name="username" class="fl"> <span class="fl warning">（用户名由字母、数字、－等字符组成）</span>
							<div class="clear"></div>
						</div>
						<div class="login_item margin-top-10">
							<label class="col-md-3 p0"><i class="red mr5">*</i>登录密码：</label> <input type="password" name="username" class="fl"> <span class="fl warning">（密码由6-20位，由字母、数字组成）</span>
							<div class="clear"></div>
						</div>
						<div class="login_item margin-top-10">
							<label class="col-md-3 p0"><i class="red mr5">*</i>确认密码：</label> <input type="password" name="username" class="fl">
							<div class="clear"></div>
						</div>
						<div class="login_item margin-top-10">
							<label class="col-md-3 p0"><i class="red mr5">*</i>手机号码：</label> <input type="text" name="username" class="fl">
							<button class="btn padding-left-10 padding-right-10 btn_back ml10">发送验证码</button>
							<div class="clear"></div>
						</div>
						<div class="login_item margin-top-10">
							<label class="col-md-3 p0"><i class="red mr5">*</i>手机验证码：</label> <input type="text" name="username" class="fl">
							<div class="clear"></div>
						</div>
						<div class="login_item margin-top-10">
							<label class="col-md-3 p0"><i class="red mr5">*</i>验证码：</label> <input type="text" name="username" class="fl input-yzm">
							<div class="fl">
								<div class="yzm fl">
						...
						<div class="tc mt20 clear col-md-11">
							<button class="btn padding-left-20 padding-right-20 btn_back margin-5" onclick="location='${pageContext.request.contextPath}/supplierInfo/register.do'">下一步</button>
							<button class="btn padding-left-20 padding-right-20 btn_back margin-5" onclick="location='${pageContext.request.contextPath}/supplierInfo/registration_page.do'">返回</button>
						</div>
					</div>
				</div>
			</div>
