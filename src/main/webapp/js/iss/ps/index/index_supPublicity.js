...
function loadData(data,index,pageNum,pageSize){
	var html = "<li> "
             ...
             + "  <span class='col-md-4 col-xs-4 col-sm-4 text-center' title='同意入库，选择了"+data.passCateCount+"个产品类别，通过了"+(data.passCateCount - data.noPassCateCount)+"个产品类别。"+data.auditOpinion+"'>"
