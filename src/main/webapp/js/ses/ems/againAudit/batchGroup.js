        ...
        if (typeof(list_content) != 'undefined') {
          ...
          for (var i in list_content.list) {
            ...
            $('#list_content').append('<tr>'
              ...
              +'<td class="text-center break-all">'+ list_content.list[ii].expertsTypeId +'</td>'
              +'<td class="text-center break-all">'+ list_content.list[ii].expertsFrom +'</td>'
