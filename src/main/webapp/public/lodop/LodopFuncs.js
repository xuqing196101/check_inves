...
function getLodop(oOBJECT, oEMBED) {
	...
	var strCLodopInstall = "<br><font color='#FF00FF'>CLodop云打印服务未安装启动!点击这里<a style='margin-left: 10px;' href=/" + href + "/public/lodop/lodop.zip target='_self' download='lodop.zip'>执行安装</a>,安装后请刷新页面。</font>";
