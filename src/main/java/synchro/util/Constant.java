...
public class Constant {
    ...
    /**专家复审准批件**/
    public final static String EXPERT_REVIEW_APPROVE = "EXPERT_REVIEW_APPROVE";
    ...
    /** 专家抽取结果信息 **/
    public final static String DATE_SYNCH_EXPERT_EXTRACT_RESULT ="SYNCH_E_XPERT_E_XTRACT_RESULT";
    /** 专家抽取结果信息文件名称 **/
