...
public class Constant {
	//供应商审核 资质文件物资上传 字典 code
	public static final String  SUPPLIER_APTITUD="SUPPLIER_APTITUD";
	...
	public static final String CONTRACT_PRODUCT_PAGE="contract_product_page";
	//供应商审核 记录 物资销售 销售合同标识
	public static final String CONTRACT_SALES_PAGE="contract_sales_page";
	...
	//供应商 物资 生成 标识名称
	public static final String SUPPLIER_PRODUCT_NAME="物资生产";
	//供应商 物资销售 标识名称
	public static final String SUPPLIER_SALES_NAME="物资销售";
	//供应商 工程 生成 标识名称
	public static final String SUPPLIER_PROJECT_NAME="工程";
	//供应商 服务 标识名称
	public static final String SUPPLIER_SERVICE_NAME="服务";
