	...
	public void saveOrUpdateSupplierMatPro(Supplier supplier) {
		...
		try{
			...
			for (SupplierRegPerson regPerson : listRegPersons) {
				if (regPerson != null && regPerson.getId() != null) {
					...
					if (regPersonBean != null) {
						...
						if (null == regPerson.getRegType())
							regPerson.setRegType("");
						if (null == regPerson.getRegNumber())
							regPerson.setRegNumber("");
			...
			for (SupplierCertEng certEng : listCertEngs) {
				if (certEng != null && certEng.getId() != null) {
            ...
            for (SupplierAptitute aptitute : listAptitutes) {
                if(aptitute != null && aptitute.getId() != null){
