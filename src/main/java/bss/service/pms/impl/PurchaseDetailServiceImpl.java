...
//      然后重新遍历需求部门，如果，有多个存在就给序号重新复制
  ...
  @Override
  public List<PurchaseDetail> selectByDept() {
    return purchaseDetailMapper.selectByDept();
  }

  @Override
  public List<PurchaseDetail> selectByType() {
    return purchaseDetailMapper.selectByType();
  }
