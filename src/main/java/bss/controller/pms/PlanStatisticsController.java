...
public class PlanStatisticsController extends BaseController {
     ...
     * @throws IOException 
     * @Title: queryPlan
     * @Description: 统计分析查询 author: Li Xiaoxiao
     ...
     */
    @RequestMapping("/list")
    public String queryPlan(@CurrentUser User user, CollectPlan collectPlan, Integer page, Model model, String year) throws IOException {
        ...
        List<CollectPlan> list = collectPlanService.getSummary(collectPlan,
            page == null ? 1 : page);
     ...
     * @Title: bar
     * @Description: 图形统计 author: Li Xiaoxiao
     * @param @param purchaseRequired
     * @param @param sign
     * @param @return
     * @return String
    ...
    @ResponseBody
    public String bar(@CurrentUser User user, PurchaseRequired purchaseRequired, String year)
        throws UnsupportedEncodingException {
        Orgnization orgnization = orgnizationServiceI.findByCategoryId(user.getOrg().getId());
    ...
    /**
     * @Title: pipe
     * @Description: 按采购方式统计 author: Li Xiaoxiao
     * @param @param purchaseRequired
     * @param @param year
     * @param @return
     * @return String
    ...
    /**
     * @Title: line
     * @Description: 按月份统计 author: Li Xiaoxiao
     * @param @param purchaseRequired
     * @param @param year
     * @param @return
     * @return String
