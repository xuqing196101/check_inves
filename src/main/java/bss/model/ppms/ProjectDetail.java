...
public class ProjectDetail {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((isTurnUp == null) ? 0 : isTurnUp.hashCode());
		...
		result = prime * result
				+ ((quotePrice == null) ? 0 : quotePrice.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (isFreeTax == null) {
			...
			return false;
		if (isTurnUp == null) {
			if (other.isTurnUp != null)
				return false;
		} else if (!isTurnUp.equals(other.isTurnUp))
			return false;
		if (item == null) {
			if (other.item != null)
				return false;
		...
		if (qualitStand == null) {
			...
			return false;
		if (quotePrice == null) {
			if (other.quotePrice != null)
				return false;
		} else if (!quotePrice.equals(other.quotePrice))
			return false;
		if (remark == null) {
