...
/**
  ...
  public int hashCode() {
    ...
    result = prime * result + ((cometId == null) ? 0 : cometId.hashCode());
    result = prime * result
    ...
    result = prime * result
        + ((listExpExtCondition == null) ? 0 : listExpExtCondition.hashCode());
    result = prime * result
    ...
    result = prime * result
        + ((listScoreTechnology == null) ? 0 : listScoreTechnology.hashCode());
    result = prime * result
    ...
    result = prime * result
        + ((supplierCheckPassId == null) ? 0 : supplierCheckPassId.hashCode());
    result = prime * result
  ...
  public boolean equals(Object obj) {
    ...
    if (collectPlan == null) {
      ...
      return false;
    if (cometId == null) {
      if (other.cometId != null)
        return false;
    } else if (!cometId.equals(other.cometId))
      return false;
    if (contractId == null) {
